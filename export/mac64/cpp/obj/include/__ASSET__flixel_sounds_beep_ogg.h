...
class HXCPP_CLASS_ATTRIBUTES __ASSET__flixel_sounds_beep_ogg_obj : public  ::openfl::_legacy::media::Sound_obj
{
	...
	public:
		...
		static hx::ObjectPtr< __ASSET__flixel_sounds_beep_ogg_obj > __alloc(hx::Ctx *_hx_ctx, ::openfl::_legacy::net::URLRequest stream, ::openfl::media::SoundLoaderContext context, ::Dynamic __o_forcePlayAsMusic);
