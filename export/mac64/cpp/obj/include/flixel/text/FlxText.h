...
class HXCPP_CLASS_ATTRIBUTES FlxText_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		::Dynamic clearFormats_dyn();
		 ...
		 ::flixel::text::FlxText setFormat(::String Font,hx::Null< int >  Size,hx::Null< int >  Color,::String Alignment, ::flixel::text::FlxTextBorderStyle BorderStyle,hx::Null< int >  BorderColor,hx::Null< bool >  Embedded);
