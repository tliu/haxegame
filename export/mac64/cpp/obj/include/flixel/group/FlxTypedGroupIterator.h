...
HX_DECLARE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_873_new)
...
HXLINE( 874)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers = GroupMembers;
HXLINE( 875)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_filter = filter;
HXLINE( 876)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_cursor = (int)0;
HXLINE( 877)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_length = ( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers->get_length();
            	}
