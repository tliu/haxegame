...
HX_DEFINE_STACK_FRAME(_hx_pos_7e4d842269e66db1_370_new,"Xml","new",0x2e496e29,"Xml.new","/usr/local/lib/haxe/std/Xml.hx",370,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_220_get,"Xml","get",0x2e441e5f,"Xml.get","/usr/local/lib/haxe/std/Xml.hx",220,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_231_set,"Xml","set",0x2e4d396b,"Xml.set","/usr/local/lib/haxe/std/Xml.hx",231,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_253_exists,"Xml","exists",0x446683b3,"Xml.exists","/usr/local/lib/haxe/std/Xml.hx",253,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_283_elements,"Xml","elements",0x0310ffce,"Xml.elements","/usr/local/lib/haxe/std/Xml.hx",283,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_293_elementsNamed,"Xml","elementsNamed",0x6b28f50b,"Xml.elementsNamed","/usr/local/lib/haxe/std/Xml.hx",293,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_310_firstElement,"Xml","firstElement",0xc103a583,"Xml.firstElement","/usr/local/lib/haxe/std/Xml.hx",310,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_326_addChild,"Xml","addChild",0x3e639952,"Xml.addChild","/usr/local/lib/haxe/std/Xml.hx",326,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_339_removeChild,"Xml","removeChild",0x9bd39581,"Xml.removeChild","/usr/local/lib/haxe/std/Xml.hx",339,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_98_parse,"Xml","parse",0x8a44f23c,"Xml.parse","/usr/local/lib/haxe/std/Xml.hx",98,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_158_createElement,"Xml","createElement",0x97359a29,"Xml.createElement","/usr/local/lib/haxe/std/Xml.hx",158,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_167_createPCData,"Xml","createPCData",0x3cc9ead0,"Xml.createPCData","/usr/local/lib/haxe/std/Xml.hx",167,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_176_createCData,"Xml","createCData",0xaf49365a,"Xml.createCData","/usr/local/lib/haxe/std/Xml.hx",176,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_185_createComment,"Xml","createComment",0x125165cc,"Xml.createComment","/usr/local/lib/haxe/std/Xml.hx",185,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_194_createDocType,"Xml","createDocType",0x696de8bf,"Xml.createDocType","/usr/local/lib/haxe/std/Xml.hx",194,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_203_createProcessingInstruction,"Xml","createProcessingInstruction",0x632a1f28,"Xml.createProcessingInstruction","/usr/local/lib/haxe/std/Xml.hx",203,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_213_createDocument,"Xml","createDocument",0xcf00030e,"Xml.createDocument","/usr/local/lib/haxe/std/Xml.hx",213,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_68_boot,"Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",68,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_72_boot,"Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",72,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_76_boot,"Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",76,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_80_boot,"Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",80,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_84_boot,"Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",84,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_88_boot,"Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",88,0x5c1024e4)
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_92_boot,"Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",92,0x5c1024e4)

void Xml_obj::__construct(int nodeType){
            	HX_GC_STACKFRAME(&_hx_pos_7e4d842269e66db1_370_new)
...
::String Xml_obj::get(::String att){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_220_get)
...
void Xml_obj::set(::String att,::String value){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_231_set)
...
bool Xml_obj::exists(::String att){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_253_exists)
...
HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,exists,return )
 ...
 ::Dynamic Xml_obj::elements(){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_283_elements)
...
HX_DEFINE_DYNAMIC_FUNC0(Xml_obj,elements,return )
 ...
 ::Dynamic Xml_obj::elementsNamed(::String name){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_293_elementsNamed)
...
HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,elementsNamed,return )
 ...
 ::Xml Xml_obj::firstElement(){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_310_firstElement)
...
void Xml_obj::addChild( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_326_addChild)
...
bool Xml_obj::removeChild( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_339_removeChild)
...
int Xml_obj::Document;
 ...
 ::Xml Xml_obj::parse(::String str){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_98_parse)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,parse,return )
 ...
 ::Xml Xml_obj::createElement(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_7e4d842269e66db1_158_createElement)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createElement,return )
 ...
 ::Xml Xml_obj::createPCData(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_7e4d842269e66db1_167_createPCData)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createPCData,return )
 ...
 ::Xml Xml_obj::createCData(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_7e4d842269e66db1_176_createCData)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createCData,return )
 ...
 ::Xml Xml_obj::createComment(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_7e4d842269e66db1_185_createComment)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createComment,return )
 ...
 ::Xml Xml_obj::createDocType(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_7e4d842269e66db1_194_createDocType)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createDocType,return )
 ...
 ::Xml Xml_obj::createProcessingInstruction(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_7e4d842269e66db1_203_createProcessingInstruction)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createProcessingInstruction,return )
 ...
 ::Xml Xml_obj::createDocument(){
            	HX_GC_STACKFRAME(&_hx_pos_7e4d842269e66db1_213_createDocument)
...
{
{
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_68_boot)
HXDLIN(  68)		Element = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_72_boot)
HXDLIN(  72)		PCData = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_76_boot)
HXDLIN(  76)		CData = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_80_boot)
HXDLIN(  80)		Comment = (int)3;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_84_boot)
HXDLIN(  84)		DocType = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_88_boot)
HXDLIN(  88)		ProcessingInstruction = (int)5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_92_boot)
