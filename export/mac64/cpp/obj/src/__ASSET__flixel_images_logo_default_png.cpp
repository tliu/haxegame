...
HXLINE(2078)		 ::openfl::_legacy::utils::ByteArray byteArray = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_images_logo_default_png_obj::resourceName));
...
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap___ASSET__flixel_images_logo_default_png",85,a1,73,91);
            	}
}
