...
HX_LOCAL_STACK_FRAME(_hx_pos_e74b11cf5585adaf_75_getPosition,"flixel.input.FlxPointer","getPosition",0x9fea8a32,"flixel.input.FlxPointer.getPosition","flixel/input/FlxPointer.hx",75,0xe6a2529b)
HX_LOCAL_STACK_FRAME(_hx_pos_e74b11cf5585adaf_92_overlaps,"flixel.input.FlxPointer","overlaps",0xe0967a59,"flixel.input.FlxPointer.overlaps","flixel/input/FlxPointer.hx",92,0xe6a2529b)
static const bool _hx_array_data_c28ed6c1_5[] = {
	0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_e74b11cf5585adaf_100_overlaps,"flixel.input.FlxPointer","overlaps",0xe0967a59,"flixel.input.FlxPointer.overlaps","flixel/input/FlxPointer.hx",100,0xe6a2529b)
HX_LOCAL_STACK_FRAME(_hx_pos_e74b11cf5585adaf_122_setGlobalScreenPositionUnsafe,"flixel.input.FlxPointer","setGlobalScreenPositionUnsafe",0x8f7aed13,"flixel.input.FlxPointer.setGlobalScreenPositionUnsafe","flixel/input/FlxPointer.hx",122,0xe6a2529b)
HX_LOCAL_STACK_FRAME(_hx_pos_e74b11cf5585adaf_131_toString,"flixel.input.FlxPointer","toString",0xd3da77f9,"flixel.input.FlxPointer.toString","flixel/input/FlxPointer.hx",131,0xe6a2529b)
HX_LOCAL_STACK_FRAME(_hx_pos_e74b11cf5585adaf_141_updatePositions,"flixel.input.FlxPointer","updatePositions",0xb47050b4,"flixel.input.FlxPointer.updatePositions","flixel/input/FlxPointer.hx",141,0xe6a2529b)
...
HXLINE(  91)		 ::flixel::input::FlxPointer _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE(  93)		::Array< bool > result = ::Array_obj< bool >::fromData( _hx_array_data_c28ed6c1_5,1);
HXLINE(  95)		 ::flixel::group::FlxTypedGroup group = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
HXLINE( 110)			 ::flixel::FlxObject object = ( ( ::flixel::FlxObject)(ObjectOrGroup) );
HXLINE( 111)			bool _hx_tmp = object->overlapsPoint(::flixel::input::FlxPointer_obj::_cachedPoint,true,Camera);
...
HXDLIN( 132)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 132)		_this->label = HX_("x",78,00,00,00);
HXDLIN( 132)		_this->value = value;
HXDLIN( 132)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
HXLINE( 133)		 ::Dynamic value1 = this->y;
HXDLIN( 133)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 133)		_this1->label = HX_("y",79,00,00,00);
HXDLIN( 133)		_this1->value = value1;
HXLINE( 131)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp)->init(1,_this1));
            	}
