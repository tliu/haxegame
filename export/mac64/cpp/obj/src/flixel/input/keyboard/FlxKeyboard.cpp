...
HX_LOCAL_STACK_FRAME(_hx_pos_86aaea01378aa57b_94_onKeyUp,"flixel.input.keyboard.FlxKeyboard","onKeyUp",0xa36f8255,"flixel.input.keyboard.FlxKeyboard.onKeyUp","flixel/input/keyboard/FlxKeyboard.hx",94,0x41882875)
...
void FlxKeyboard_obj::onKeyUp( ::openfl::_legacy::events::KeyboardEvent event){
            	HX_STACKFRAME(&_hx_pos_86aaea01378aa57b_94_onKeyUp)
HXDLIN(  94)		this->super::onKeyUp(event);
            	}
