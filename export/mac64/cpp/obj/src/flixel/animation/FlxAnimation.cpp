...
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_95_destroy,"flixel.animation.FlxAnimation","destroy",0x7cb38c5a,"flixel.animation.FlxAnimation.destroy","flixel/animation/FlxAnimation.hx",95,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_112_play,"flixel.animation.FlxAnimation","play",0xb2d17294,"flixel.animation.FlxAnimation.play","flixel/animation/FlxAnimation.hx",112,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_143_restart,"flixel.animation.FlxAnimation","restart",0xc2d3272f,"flixel.animation.FlxAnimation.restart","flixel/animation/FlxAnimation.hx",143,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_147_stop,"flixel.animation.FlxAnimation","stop",0xb4d334a2,"flixel.animation.FlxAnimation.stop","flixel/animation/FlxAnimation.hx",147,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_153_reset,"flixel.animation.FlxAnimation","reset",0xe6ad112f,"flixel.animation.FlxAnimation.reset","flixel/animation/FlxAnimation.hx",153,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_159_finish,"flixel.animation.FlxAnimation","finish",0x6ec8ecf3,"flixel.animation.FlxAnimation.finish","flixel/animation/FlxAnimation.hx",159,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_166_pause,"flixel.animation.FlxAnimation","pause",0xbd3c9e56,"flixel.animation.FlxAnimation.pause","flixel/animation/FlxAnimation.hx",166,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_171_resume,"flixel.animation.FlxAnimation","resume",0xf0ce164d,"flixel.animation.FlxAnimation.resume","flixel/animation/FlxAnimation.hx",171,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_175_reverse,"flixel.animation.FlxAnimation","reverse",0x73299882,"flixel.animation.FlxAnimation.reverse","flixel/animation/FlxAnimation.hx",175,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_182_update,"flixel.animation.FlxAnimation","update",0x6f4f32a9,"flixel.animation.FlxAnimation.update","flixel/animation/FlxAnimation.hx",182,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_209_clone,"flixel.animation.FlxAnimation","clone",0x4847dabd,"flixel.animation.FlxAnimation.clone","flixel/animation/FlxAnimation.hx",209,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_213_set_frameRate,"flixel.animation.FlxAnimation","set_frameRate",0x8699eef0,"flixel.animation.FlxAnimation.set_frameRate","flixel/animation/FlxAnimation.hx",213,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_222_set_curFrame,"flixel.animation.FlxAnimation","set_curFrame",0x46812eaa,"flixel.animation.FlxAnimation.set_curFrame","flixel/animation/FlxAnimation.hx",222,0x660bc6ae)
HX_LOCAL_STACK_FRAME(_hx_pos_4744c2053d08e87b_252_get_numFrames,"flixel.animation.FlxAnimation","get_numFrames",0x65f5f5c3,"flixel.animation.FlxAnimation.get_numFrames","flixel/animation/FlxAnimation.hx",252,0x660bc6ae)
namespace flixel{
namespace animation{
...
HXLINE( 125)		int maxFrameIndex = (this->frames->length - (int)1);
...
HXLINE( 138)			 ::flixel::animation::FlxAnimationController _this = this->parent;
...
HXDLIN( 143)		this->play(true,this->reversed,null());
            	}
...
HXLINE( 195)					 ::flixel::animation::FlxAnimation _g = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 195)					int _g1 = _g->curFrame;
HXDLIN( 195)					_g->set_curFrame((_g1 - (int)1));
            				}
            			}
            			else {
HXLINE( 199)				bool _hx_tmp6;
HXDLIN( 199)				if (this->looped) {
HXLINE( 199)					int _hx_tmp7 = this->curFrame;
HXDLIN( 199)					_hx_tmp6 = (_hx_tmp7 == (this->frames->length - (int)1));
            				}
            				else {
...
HXLINE( 202)					 ::flixel::animation::FlxAnimation _g2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 202)					int _g11 = _g2->curFrame;
HXDLIN( 202)					_g2->set_curFrame((_g11 + (int)1));
            				}
            			}
            		}
            		_hx_goto_10:;
...
HXDLIN( 209)		return  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,Parent,this->name,this->frames,this->frameRate,this->looped,this->flipX,this->flipY);
            	}
...
HXLINE( 223)		int maxFrameIndex = (this->frames->length - (int)1);
...
HXLINE( 245)			 ::flixel::animation::FlxAnimationController _this = this->parent;
