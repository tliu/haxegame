...
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_179_add,"flixel.animation.FlxAnimationController","add",0x0b5a99bd,"flixel.animation.FlxAnimationController.add","flixel/animation/FlxAnimationController.hx",179,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_213_remove,"flixel.animation.FlxAnimationController","remove",0x0d379e28,"flixel.animation.FlxAnimationController.remove","flixel/animation/FlxAnimationController.hx",213,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_231_append,"flixel.animation.FlxAnimationController","append",0x9882e3be,"flixel.animation.FlxAnimationController.append","flixel/animation/FlxAnimationController.hx",231,0xa6f01372)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_318_addByStringIndices,"flixel.animation.FlxAnimationController","addByStringIndices",0x0f3d3cc2,"flixel.animation.FlxAnimationController.addByStringIndices","flixel/animation/FlxAnimationController.hx",318,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_342_appendByStringIndices,"flixel.animation.FlxAnimationController","appendByStringIndices",0x42285be1,"flixel.animation.FlxAnimationController.appendByStringIndices","flixel/animation/FlxAnimationController.hx",342,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_371_addByIndices,"flixel.animation.FlxAnimationController","addByIndices",0x4dbf3893,"flixel.animation.FlxAnimationController.addByIndices","flixel/animation/FlxAnimationController.hx",371,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_396_appendByIndices,"flixel.animation.FlxAnimationController","appendByIndices",0x22882672,"flixel.animation.FlxAnimationController.appendByIndices","flixel/animation/FlxAnimationController.hx",396,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_417_findSpriteFrame,"flixel.animation.FlxAnimationController","findSpriteFrame",0x746a2bcb,"flixel.animation.FlxAnimationController.findSpriteFrame","flixel/animation/FlxAnimationController.hx",417,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_448_addByPrefix,"flixel.animation.FlxAnimationController","addByPrefix",0x4347f9a6,"flixel.animation.FlxAnimationController.addByPrefix","flixel/animation/FlxAnimationController.hx",448,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_477_appendByPrefix,"flixel.animation.FlxAnimationController","appendByPrefix",0xd3bbaca7,"flixel.animation.FlxAnimationController.appendByPrefix","flixel/animation/FlxAnimationController.hx",477,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_508_play,"flixel.animation.FlxAnimationController","play",0xeddc2ed8,"flixel.animation.FlxAnimationController.play","flixel/animation/FlxAnimationController.hx",508,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_547_reset,"flixel.animation.FlxAnimationController","reset",0x5507106b,"flixel.animation.FlxAnimationController.reset","flixel/animation/FlxAnimationController.hx",547,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_558_finish,"flixel.animation.FlxAnimationController","finish",0x8f2e4237,"flixel.animation.FlxAnimationController.finish","flixel/animation/FlxAnimationController.hx",558,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_569_stop,"flixel.animation.FlxAnimationController","stop",0xefddf0e6,"flixel.animation.FlxAnimationController.stop","flixel/animation/FlxAnimationController.hx",569,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_580_pause,"flixel.animation.FlxAnimationController","pause",0x2b969d92,"flixel.animation.FlxAnimationController.pause","flixel/animation/FlxAnimationController.hx",580,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_591_resume,"flixel.animation.FlxAnimationController","resume",0x11336b91,"flixel.animation.FlxAnimationController.resume","flixel/animation/FlxAnimationController.hx",591,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_602_reverse,"flixel.animation.FlxAnimationController","reverse",0xab6edebe,"flixel.animation.FlxAnimationController.reverse","flixel/animation/FlxAnimationController.hx",602,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_613_getByName,"flixel.animation.FlxAnimationController","getByName",0x1940f994,"flixel.animation.FlxAnimationController.getByName","flixel/animation/FlxAnimationController.hx",613,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_621_randomFrame,"flixel.animation.FlxAnimationController","randomFrame",0x12c43ec6,"flixel.animation.FlxAnimationController.randomFrame","flixel/animation/FlxAnimationController.hx",621,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_632_fireCallback,"flixel.animation.FlxAnimationController","fireCallback",0x1523547f,"flixel.animation.FlxAnimationController.fireCallback","flixel/animation/FlxAnimationController.hx",632,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_643_fireFinishCallback,"flixel.animation.FlxAnimationController","fireFinishCallback",0x96b92372,"flixel.animation.FlxAnimationController.fireFinishCallback","flixel/animation/FlxAnimationController.hx",643,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_654_byNamesHelper,"flixel.animation.FlxAnimationController","byNamesHelper",0x4e6fbd5b,"flixel.animation.FlxAnimationController.byNamesHelper","flixel/animation/FlxAnimationController.hx",654,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_669_byStringIndicesHelper,"flixel.animation.FlxAnimationController","byStringIndicesHelper",0xccff0b69,"flixel.animation.FlxAnimationController.byStringIndicesHelper","flixel/animation/FlxAnimationController.hx",669,0xa6f01372)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_699_byPrefixHelper,"flixel.animation.FlxAnimationController","byPrefixHelper",0x238152fb,"flixel.animation.FlxAnimationController.byPrefixHelper","flixel/animation/FlxAnimationController.hx",699,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_716_findByPrefix,"flixel.animation.FlxAnimationController","findByPrefix",0x32419106,"flixel.animation.FlxAnimationController.findByPrefix","flixel/animation/FlxAnimationController.hx",716,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_726_set_frameIndex,"flixel.animation.FlxAnimationController","set_frameIndex",0xd769c646,"flixel.animation.FlxAnimationController.set_frameIndex","flixel/animation/FlxAnimationController.hx",726,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_740_get_frameName,"flixel.animation.FlxAnimationController","get_frameName",0x1674c78b,"flixel.animation.FlxAnimationController.get_frameName","flixel/animation/FlxAnimationController.hx",740,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_744_set_frameName,"flixel.animation.FlxAnimationController","set_frameName",0x5b7aa997,"flixel.animation.FlxAnimationController.set_frameName","flixel/animation/FlxAnimationController.hx",744,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_764_get_name,"flixel.animation.FlxAnimationController","get_name",0x9c9870b8,"flixel.animation.FlxAnimationController.get_name","flixel/animation/FlxAnimationController.hx",764,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_774_set_name,"flixel.animation.FlxAnimationController","set_name",0x4af5ca2c,"flixel.animation.FlxAnimationController.set_name","flixel/animation/FlxAnimationController.hx",774,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_781_get_curAnim,"flixel.animation.FlxAnimationController","get_curAnim",0xd32cfb64,"flixel.animation.FlxAnimationController.get_curAnim","flixel/animation/FlxAnimationController.hx",781,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_785_set_curAnim,"flixel.animation.FlxAnimationController","set_curAnim",0xdd9a0270,"flixel.animation.FlxAnimationController.set_curAnim","flixel/animation/FlxAnimationController.hx",785,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_802_get_paused,"flixel.animation.FlxAnimationController","get_paused",0x1a2b745b,"flixel.animation.FlxAnimationController.get_paused","flixel/animation/FlxAnimationController.hx",802,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_812_set_paused,"flixel.animation.FlxAnimationController","set_paused",0x1da912cf,"flixel.animation.FlxAnimationController.set_paused","flixel/animation/FlxAnimationController.hx",812,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_828_get_finished,"flixel.animation.FlxAnimationController","get_finished",0x1eabcc5f,"flixel.animation.FlxAnimationController.get_finished","flixel/animation/FlxAnimationController.hx",828,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_838_set_finished,"flixel.animation.FlxAnimationController","set_finished",0x33a4efd3,"flixel.animation.FlxAnimationController.set_finished","flixel/animation/FlxAnimationController.hx",838,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_848_get_frames,"flixel.animation.FlxAnimationController","get_frames",0xd72ce353,"flixel.animation.FlxAnimationController.get_frames","flixel/animation/FlxAnimationController.hx",848,0xa6f01372)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed655cc53689dfd_859_getFrameIndex,"flixel.animation.FlxAnimationController","getFrameIndex",0x1c3dee77,"flixel.animation.FlxAnimationController.getFrameIndex","flixel/animation/FlxAnimationController.hx",859,0xa6f01372)
namespace flixel{
namespace animation{
...
HXLINE( 181)		::Array< int > framesToAdd = Frames;
HXLINE( 182)		int numFrames = (framesToAdd->length - (int)1);
HXLINE( 183)		int i = numFrames;
...
HXLINE( 202)			 ::flixel::animation::FlxAnimation anim =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),Name,framesToAdd,FrameRate,Looped,FlipX,FlipY);
...
HXLINE( 214)		 ::flixel::animation::FlxAnimation anim = this->_animations->get(Name).StaticCast<  ::flixel::animation::FlxAnimation >();
...
HXDLIN( 318)		if (hx::IsNotNull( this->_sprite->frames )) {
HXLINE( 320)			::Array< int > frameIndices = ::Array_obj< int >::__new();
HXLINE( 321)			this->byStringIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 323)			if ((frameIndices->length > (int)0)) {
HXLINE( 325)				 ::flixel::animation::FlxAnimation anim =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
HXDLIN( 371)		if (hx::IsNotNull( this->_sprite->frames )) {
HXLINE( 373)			::Array< int > frameIndices = ::Array_obj< int >::__new();
HXLINE( 374)			this->byIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 376)			if ((frameIndices->length > (int)0)) {
HXLINE( 378)				 ::flixel::animation::FlxAnimation anim =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
HXLINE( 418)		int numFrames = this->_sprite->numFrames;
HXLINE( 419)		::Array< ::Dynamic> flxFrames = this->_sprite->frames->frames;
HXLINE( 420)		{
HXLINE( 420)			int _g1 = (int)0;
HXDLIN( 420)			int _g = numFrames;
HXDLIN( 420)			while((_g1 < _g)){
HXLINE( 420)				_g1 = (_g1 + (int)1);
HXDLIN( 420)				int i = (_g1 - (int)1);
HXLINE( 422)				::String name = flxFrames->__get(i).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
...
HXLINE( 425)					int Prefix1 = Prefix.length;
HXDLIN( 425)					 ::Dynamic index = ::Std_obj::parseInt(name.substring(Prefix1,(name.length - Postfix.length)));
...
HXLINE( 450)			::Array< ::Dynamic> animFrames = ::Array_obj< ::Dynamic>::__new();
HXLINE( 451)			this->findByPrefix(animFrames,Prefix);
HXLINE( 453)			if ((animFrames->length > (int)0)) {
HXLINE( 455)				::Array< int > frameIndices = ::Array_obj< int >::__new();
HXLINE( 456)				this->byPrefixHelper(frameIndices,animFrames,Prefix);
HXLINE( 458)				if ((frameIndices->length > (int)0)) {
HXLINE( 460)					 ::flixel::animation::FlxAnimation anim =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
HXLINE( 525)		bool oldFlipY = false;
...
HXDLIN( 547)		if (hx::IsNotNull( this->_curAnim )) {
...
HXDLIN( 613)		return this->_animations->get(Name).StaticCast<  ::flixel::animation::FlxAnimation >();
            	}
...
HXLINE( 627)		 ::flixel::math::FlxRandom _hx_tmp = ::flixel::FlxG_obj::random;
HXDLIN( 627)		this->set_frameIndex(_hx_tmp->_hx_int((int)0,(this->_sprite->numFrames - (int)1),null()));
            	}
...
HXDLIN( 632)		if (hx::IsNotNull( this->callback )) {
HXLINE( 634)			::String name;
...
HXDLIN( 643)		if (hx::IsNotNull( this->finishCallback )) {
...
HXDLIN( 654)		int _g = (int)0;
HXDLIN( 654)		while((_g < FrameNames->length)){
HXDLIN( 654)			::String frameName = FrameNames->__get(_g);
HXDLIN( 654)			_g = (_g + (int)1);
HXLINE( 656)			if (this->_sprite->frames->framesHash->exists(frameName)) {
HXLINE( 658)				 ::flixel::graphics::frames::FlxFrame frameToAdd = this->_sprite->frames->framesHash->get(frameName).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXDLIN( 669)		int _g = (int)0;
HXDLIN( 669)		while((_g < Indices->length)){
HXDLIN( 669)			::String index = Indices->__get(_g);
HXDLIN( 669)			_g = (_g + (int)1);
HXLINE( 671)			::String name = ((Prefix + index) + Postfix);
HXLINE( 672)			if (this->_sprite->frames->framesHash->exists(name)) {
HXLINE( 674)				 ::flixel::graphics::frames::FlxFrame frameToAdd = this->_sprite->frames->framesHash->get(name).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXLINE( 700)		::String name = AnimFrames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
HXLINE( 701)		int postIndex = name.indexOf(HX_(".",2e,00,00,00),Prefix.length);
...
HXDLIN( 702)		::String postFix1 = name.substring(postFix,name.length);
HXLINE( 703)		::flixel::graphics::frames::FlxFrame_obj::sort(AnimFrames,Prefix.length,postFix1.length);
HXLINE( 705)		{
HXLINE( 705)			int _g = (int)0;
HXDLIN( 705)			while((_g < AnimFrames->length)){
HXLINE( 705)				 ::flixel::graphics::frames::FlxFrame animFrame = AnimFrames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXDLIN( 716)		int _g = (int)0;
HXDLIN( 716)		::Array< ::Dynamic> _g1 = this->_sprite->frames->frames;
HXDLIN( 716)		while((_g < _g1->length)){
HXDLIN( 716)			 ::flixel::graphics::frames::FlxFrame frame = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXLINE( 730)			 ::flixel::FlxSprite _hx_tmp = this->_sprite;
HXDLIN( 730)			_hx_tmp->set_frame(this->_sprite->frames->frames->__get(Frame).StaticCast<  ::flixel::graphics::frames::FlxFrame >());
HXLINE( 731)			this->frameIndex = Frame;
HXLINE( 732)			if (hx::IsNotNull( this->callback )) {
HXLINE( 732)				::String name;
...
HXDLIN( 740)		return this->_sprite->frame->name;
            	}
...
HXLINE( 753)			 ::flixel::graphics::frames::FlxFrame frame = this->_sprite->frames->framesHash->get(Value).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXLINE( 765)		::String animName = null();
...
HXDLIN( 781)		return this->_curAnim;
            	}
...
HXDLIN( 848)		return this->_sprite->numFrames;
            	}
...
HXDLIN( 859)		return this->_sprite->frames->frames->indexOf(Frame,null());
            	}
