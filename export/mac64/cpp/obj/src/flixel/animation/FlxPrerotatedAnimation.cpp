...
HX_LOCAL_STACK_FRAME(_hx_pos_2fc827bb1ad10643_45_set_curIndex,"flixel.animation.FlxPrerotatedAnimation","set_curIndex",0x8ed63595,"flixel.animation.FlxPrerotatedAnimation.set_curIndex","flixel/animation/FlxPrerotatedAnimation.hx",45,0x4a5f70b4)
HX_LOCAL_STACK_FRAME(_hx_pos_2fc827bb1ad10643_58_clone,"flixel.animation.FlxPrerotatedAnimation","clone",0x470ab1f7,"flixel.animation.FlxPrerotatedAnimation.clone","flixel/animation/FlxPrerotatedAnimation.hx",58,0x4a5f70b4)
...
HXLINE(  26)		int oldIndex = this->curIndex;
HXLINE(  27)		int angleHelper = ::Math_obj::floor(hx::Mod(Value,(int)360));
HXLINE(  29)		while((angleHelper < (int)0)){
HXLINE(  31)			angleHelper = (angleHelper + (int)360);
            		}
HXLINE(  34)		int newIndex = ::Math_obj::floor((((Float)angleHelper / (Float)this->baked) + ((Float)0.5)));
HXLINE(  35)		newIndex = ::Std_obj::_hx_int(hx::Mod(newIndex,this->rotations));
...
int FlxPrerotatedAnimation_obj::set_curIndex(int Value){
            	HX_STACKFRAME(&_hx_pos_2fc827bb1ad10643_45_set_curIndex)
HXLINE(  46)		this->curIndex = Value;
HXLINE(  48)		if (hx::IsNotNull( this->parent )) {
...
HXLINE(  53)		return Value;
 ...
 ::flixel::animation::FlxBaseAnimation FlxPrerotatedAnimation_obj::clone( ::flixel::animation::FlxAnimationController Parent){
            	HX_GC_STACKFRAME(&_hx_pos_2fc827bb1ad10643_58_clone)
HXDLIN(  58)		return  ::flixel::animation::FlxPrerotatedAnimation_obj::__alloc( HX_CTX ,Parent,this->baked);
            	}
