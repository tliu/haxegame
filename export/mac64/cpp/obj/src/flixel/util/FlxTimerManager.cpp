...
HX_LOCAL_STACK_FRAME(_hx_pos_626da793e26fdbd0_240_destroy,"flixel.util.FlxTimerManager","destroy",0xb435da0c,"flixel.util.FlxTimerManager.destroy","flixel/util/FlxTimer.hx",240,0x0a681e11)
HX_LOCAL_STACK_FRAME(_hx_pos_626da793e26fdbd0_252_update,"flixel.util.FlxTimerManager","update",0xf26da137,"flixel.util.FlxTimerManager.update","flixel/util/FlxTimer.hx",252,0x0a681e11)
HX_LOCAL_STACK_FRAME(_hx_pos_626da793e26fdbd0_290_add,"flixel.util.FlxTimerManager","add",0x36752e33,"flixel.util.FlxTimerManager.add","flixel/util/FlxTimer.hx",290,0x0a681e11)
HX_LOCAL_STACK_FRAME(_hx_pos_626da793e26fdbd0_302_remove,"flixel.util.FlxTimerManager","remove",0x6ff0b772,"flixel.util.FlxTimerManager.remove","flixel/util/FlxTimer.hx",302,0x0a681e11)
HX_LOCAL_STACK_FRAME(_hx_pos_626da793e26fdbd0_311_completeAll,"flixel.util.FlxTimerManager","completeAll",0x4a72c7fa,"flixel.util.FlxTimerManager.completeAll","flixel/util/FlxTimer.hx",311,0x0a681e11)
HX_LOCAL_STACK_FRAME(_hx_pos_626da793e26fdbd0_333_clear,"flixel.util.FlxTimerManager","clear",0xccdb561f,"flixel.util.FlxTimerManager.clear","flixel/util/FlxTimer.hx",333,0x0a681e11)
HX_LOCAL_STACK_FRAME(_hx_pos_626da793e26fdbd0_344_forEach,"flixel.util.FlxTimerManager","forEach",0x546dd6bc,"flixel.util.FlxTimerManager.forEach","flixel/util/FlxTimer.hx",344,0x0a681e11)
namespace flixel{
namespace util{
...
HXLINE( 253)		::Array< ::Dynamic> loopedTimers = null();
HXLINE( 255)		{
HXLINE( 255)			int _g = (int)0;
HXDLIN( 255)			::Array< ::Dynamic> _g1 = this->_timers;
HXDLIN( 255)			while((_g < _g1->length)){
HXLINE( 255)				 ::flixel::util::FlxTimer timer = _g1->__get(_g).StaticCast<  ::flixel::util::FlxTimer >();
...
HXLINE( 259)					int timerLoops = timer->_loopsCounter;
...
HXDLIN( 290)		this->_timers->push(Timer);
            	}
...
HXDLIN( 302)		::Array< ::Dynamic> array = this->_timers;
HXDLIN( 302)		int index = array->indexOf(Timer,null());
HXDLIN( 302)		if ((index != (int)-1)) {
HXDLIN( 302)			array[index] = array->__get((array->length - (int)1)).StaticCast<  ::flixel::util::FlxTimer >();
...
HXLINE( 312)		::Array< ::Dynamic> timersToFinish = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 313)		{
HXLINE( 313)			int _g = (int)0;
HXDLIN( 313)			::Array< ::Dynamic> _g1 = this->_timers;
HXDLIN( 313)			while((_g < _g1->length)){
HXLINE( 313)				 ::flixel::util::FlxTimer timer = _g1->__get(_g).StaticCast<  ::flixel::util::FlxTimer >();
...
HXLINE( 317)				 ::flixel::util::FlxTimer timer1 = timersToFinish->__get(_g2).StaticCast<  ::flixel::util::FlxTimer >();
...
HXDLIN( 333)		::flixel::util::FlxArrayUtil_obj::clearArray(this->_timers,null());
            	}
...
HXDLIN( 344)		int _g = (int)0;
HXDLIN( 344)		::Array< ::Dynamic> _g1 = this->_timers;
HXDLIN( 344)		while((_g < _g1->length)){
HXDLIN( 344)			 ::flixel::util::FlxTimer timer = _g1->__get(_g).StaticCast<  ::flixel::util::FlxTimer >();
