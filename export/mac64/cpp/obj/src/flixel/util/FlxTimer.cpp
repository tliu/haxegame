...
HXDLIN( 191)		return (this->time - this->_timeCounter);
            	}
...
HXDLIN( 196)		return this->_timeCounter;
            	}
...
HXDLIN( 201)		return (this->loops - this->_loopsCounter);
            	}
...
HXDLIN( 206)		return this->_loopsCounter;
            	}
...
HXDLIN( 211)		if ((this->time > (int)0)) {
HXDLIN( 211)			return ((Float)this->_timeCounter / (Float)this->time);
            		}
            		else {
HXDLIN( 211)			return (int)0;
            		}
