...
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_882_next,"flixel.group.FlxTypedGroupIterator","next",0x8b82aaad,"flixel.group.FlxTypedGroupIterator.next","flixel/group/FlxGroup.hx",882,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_886_hasNext,"flixel.group.FlxTypedGroupIterator","hasNext",0x559d4ff3,"flixel.group.FlxTypedGroupIterator.hasNext","flixel/group/FlxGroup.hx",886,0x1e89d58e)
namespace flixel{
namespace group{
...
HXDLIN( 882)		if (this->hasNext()) {
HXDLIN( 882)			::cpp::VirtualArray _hx_tmp = this->_groupMembers;
HXDLIN( 882)			return _hx_tmp->__get(this->_cursor++);
            		}
            		else {
...
HXLINE( 887)						 ::Dynamic _hx_tmp1 = this->_filter;
HXDLIN( 887)						_hx_tmp = !(( (bool)(_hx_tmp1(this->_groupMembers->__get(this->_cursor))) ));
            					}
            					else {
