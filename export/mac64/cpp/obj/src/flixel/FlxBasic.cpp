...
HXDLIN( 130)		return (this->visible = Value);
            	}
...
HXDLIN( 136)		return (this->active = Value);
            	}
...
HXDLIN( 142)		return (this->exists = Value);
            	}
...
HXDLIN( 148)		return (this->alive = Value);
            	}
...
HXDLIN( 154)			_hx_tmp = (this->_cameras->length == (int)0);
            		}
            		else {
HXDLIN( 154)			_hx_tmp = true;
            		}
HXDLIN( 154)		if (_hx_tmp) {
HXDLIN( 154)			return ::flixel::FlxCamera_obj::defaultCameras->__get((int)0).StaticCast<  ::flixel::FlxCamera >();
            		}
            		else {
HXDLIN( 154)			return this->_cameras->__get((int)0).StaticCast<  ::flixel::FlxCamera >();
            		}
...
HXDLIN( 170)		if (hx::IsNull( this->_cameras )) {
HXDLIN( 170)			return ::flixel::FlxCamera_obj::defaultCameras;
            		}
            		else {
HXDLIN( 170)			return this->_cameras;
            		}
...
HXDLIN( 176)		return (this->_cameras = Value);
            	}
