...
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_53_draw,"flixel.FlxSubState","draw",0xafc56fc1,"flixel.FlxSubState.draw","flixel/FlxSubState.hx",53,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_72_destroy,"flixel.FlxSubState","destroy",0xc08a1d5d,"flixel.FlxSubState.destroy","flixel/FlxSubState.hx",72,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_84_close,"flixel.FlxSubState","close",0x85a9195b,"flixel.FlxSubState.close","flixel/FlxSubState.hx",84,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_93_get_bgColor,"flixel.FlxSubState","get_bgColor",0x02e53f58,"flixel.FlxSubState.get_bgColor","flixel/FlxSubState.hx",93,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_98_set_bgColor,"flixel.FlxSubState","set_bgColor",0x0d524664,"flixel.FlxSubState.set_bgColor","flixel/FlxSubState.hx",98,0xd8a3e54e)
namespace flixel{
...
HXDLIN(  57)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN(  57)			while((_g < _g1->length)){
HXLINE(  57)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN(  84)			_hx_tmp = hx::IsEq( this->_parentState->subState,hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXDLIN(  93)		return this->_bgColor;
            	}
