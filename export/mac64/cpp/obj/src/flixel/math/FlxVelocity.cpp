...
HXLINE(  25)		Float dx = (Dest->x + Dest->origin->x);
HXDLIN(  25)		Float dx1 = (dx - (Source->x + Source->origin->x));
HXDLIN(  25)		Float dy = (Dest->y + Dest->origin->y);
HXDLIN(  25)		Float dy1 = (dy - (Source->y + Source->origin->y));
HXDLIN(  25)		Float a;
HXDLIN(  25)		a = ::Math_obj::atan2(dy1,dx1);
HXLINE(  27)		if ((MaxTime > (int)0)) {
HXLINE(  29)			Float dx2 = (Source->x + Source->origin->x);
HXDLIN(  29)			Float dx3 = (dx2 - (Dest->x + Dest->origin->x));
HXDLIN(  29)			Float dy2 = (Source->y + Source->origin->y);
HXDLIN(  29)			Float dy3 = (dy2 - (Dest->y + Dest->origin->y));
HXDLIN(  29)			int d = ::Std_obj::_hx_int(::Math_obj::sqrt(((dx3 * dx3) + (dy3 * dy3))));
...
HXLINE(  51)		Float dx = (Dest->x + Dest->origin->x);
HXDLIN(  51)		Float dx1 = (dx - (Source->x + Source->origin->x));
HXDLIN(  51)		Float dy = (Dest->y + Dest->origin->y);
HXDLIN(  51)		Float dy1 = (dy - (Source->y + Source->origin->y));
HXDLIN(  51)		Float a;
HXDLIN(  51)		a = ::Math_obj::atan2(dy1,dx1);
HXLINE(  52)		{
...
HXLINE( 219)		int FacingBitmask = Parent->facing;
HXDLIN( 219)		bool AsDegrees = false;
HXDLIN( 219)		int degrees;
...
HXLINE( 219)				degrees = (int)90;
            			...
            			break;
            			default:{
HXLINE( 219)				int f = FacingBitmask;
HXDLIN( 219)				if ((f == (int)257)) {
HXLINE( 219)					degrees = (int)-135;
            				}
            				else {
HXLINE( 219)					int f1 = FacingBitmask;
HXDLIN( 219)					if ((f1 == (int)272)) {
HXLINE( 219)						degrees = (int)-45;
            					}
            					else {
HXLINE( 219)						int f2 = FacingBitmask;
HXDLIN( 219)						if ((f2 == (int)4097)) {
HXLINE( 219)							degrees = (int)135;
            						}
            						else {
HXLINE( 219)							int f3 = FacingBitmask;
HXDLIN( 219)							if ((f3 == (int)4112)) {
HXLINE( 219)								degrees = (int)45;
            							}
            							else {
HXLINE( 219)								degrees = (int)0;
...
HXDLIN( 219)		Float a;
HXDLIN( 219)		if (AsDegrees) {
HXLINE( 219)			a = degrees;
            		}
            		else {
HXLINE( 219)			a = (degrees * ((Float)::Math_obj::PI / (Float)(int)180));
            		}
