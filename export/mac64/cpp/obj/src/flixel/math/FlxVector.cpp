...
HXDLIN( 179)		return (::Math_obj::abs((_hx_tmp + (this->y * v->y))) < ((Float)9.99999999999999841e-15));
            	}
...
HXDLIN( 201)		return (::Math_obj::abs((_hx_tmp - (this->y * v->x))) < ((Float)9.99999999999999841e-15));
            	}
...
HXDLIN( 240)		return (::Math_obj::abs(((_hx_tmp + (this->y * this->y)) - (int)1)) < ((Float)9.99999999999999841e-15));
            	}
...
HXDLIN( 386)		if ((::Math_obj::abs((_hx_tmp - (this->y * v->x))) < ((Float)9.99999999999999841e-15))) {
HXLINE( 386)			return ::Math_obj::NaN;
            		}
HXLINE( 387)		bool _hx_tmp1;
HXDLIN( 387)		Float _hx_tmp2 = (this->x * this->x);
HXDLIN( 387)		if (!(((_hx_tmp2 + (this->y * this->y)) < ((Float)9.99999999999999841e-15)))) {
HXLINE( 387)			Float _hx_tmp3 = (v->x * v->x);
HXDLIN( 387)			_hx_tmp1 = ((_hx_tmp3 + (v->y * v->y)) < ((Float)9.99999999999999841e-15));
            		}
            		else {
...
HXDLIN(  11)		EPSILON_SQUARED = ((Float)9.99999999999999841e-15);
            	}
{
