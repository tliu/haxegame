...
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_398_equals,"flixel.math.FlxPoint","equals",0x4cd20ebb,"flixel.math.FlxPoint.equals","flixel/math/FlxPoint.hx",398,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_407_destroy,"flixel.math.FlxPoint","destroy",0xdae378fe,"flixel.math.FlxPoint.destroy","flixel/math/FlxPoint.hx",407,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_415_transform,"flixel.math.FlxPoint","transform",0x46de8270,"flixel.math.FlxPoint.transform","flixel/math/FlxPoint.hx",415,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_427_toString,"flixel.math.FlxPoint","toString",0x13b40828,"flixel.math.FlxPoint.toString","flixel/math/FlxPoint.hx",427,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_437_set_x,"flixel.math.FlxPoint","set_x",0x1a631e5f,"flixel.math.FlxPoint.set_x","flixel/math/FlxPoint.hx",437,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_445_set_y,"flixel.math.FlxPoint","set_y",0x1a631e60,"flixel.math.FlxPoint.set_y","flixel/math/FlxPoint.hx",445,0xb3e1cd2c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cceaeff5e596bc9e_450_get_pool,"flixel.math.FlxPoint","get_pool",0xa55c73e1,"flixel.math.FlxPoint.get_pool","flixel/math/FlxPoint.hx",450,0xb3e1cd2c)
...
HX_DEFINE_DYNAMIC_FUNC0(FlxPoint_obj,destroy,(void))
 ...
 ::flixel::math::FlxPoint FlxPoint_obj::transform( ::openfl::_legacy::geom::Matrix matrix){
            	HX_STACKFRAME(&_hx_pos_cceaeff5e596bc9e_415_transform)
HXLINE( 416)		Float x1 = (this->x * matrix->a);
HXDLIN( 416)		Float x11 = ((x1 + (this->y * matrix->c)) + matrix->tx);
HXLINE( 417)		Float y1 = (this->x * matrix->b);
HXDLIN( 417)		Float y11 = ((y1 + (this->y * matrix->d)) + matrix->ty);
HXLINE( 419)		return this->set(x11,y11);
            	}
...
HXDLIN( 428)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 428)		_this->label = HX_("x",78,00,00,00);
HXDLIN( 428)		_this->value = value;
HXDLIN( 428)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
HXLINE( 429)		 ::Dynamic value1 = this->y;
HXDLIN( 429)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 429)		_this1->label = HX_("y",79,00,00,00);
HXDLIN( 429)		_this1->value = value1;
HXLINE( 427)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp)->init(1,_this1));
            	}
...
HXDLIN( 437)		return (this->x = Value);
            	}
...
HXDLIN( 445)		return (this->y = Value);
            	}
...
HXDLIN( 450)		return ::flixel::math::FlxPoint_obj::_pool;
            	}
