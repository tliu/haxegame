...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_421_undump,"flixel.graphics.FlxGraphic","undump",0xf6fcc174,"flixel.graphics.FlxGraphic.undump","flixel/graphics/FlxGraphic.hx",421,0xb3633517)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_492_addFrameCollection,"flixel.graphics.FlxGraphic","addFrameCollection",0x06dd03b1,"flixel.graphics.FlxGraphic.addFrameCollection","flixel/graphics/FlxGraphic.hx",492,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_506_getFramesCollections,"flixel.graphics.FlxGraphic","getFramesCollections",0xa4089c80,"flixel.graphics.FlxGraphic.getFramesCollections","flixel/graphics/FlxGraphic.hx",506,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_524_getEmptyFrame,"flixel.graphics.FlxGraphic","getEmptyFrame",0xc5b0f80f,"flixel.graphics.FlxGraphic.getEmptyFrame","flixel/graphics/FlxGraphic.hx",524,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_536_get_tilesheet,"flixel.graphics.FlxGraphic","get_tilesheet",0x1819f201,"flixel.graphics.FlxGraphic.get_tilesheet","flixel/graphics/FlxGraphic.hx",536,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_558_getBitmapFromSystem,"flixel.graphics.FlxGraphic","getBitmapFromSystem",0xb3be27b7,"flixel.graphics.FlxGraphic.getBitmapFromSystem","flixel/graphics/FlxGraphic.hx",558,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_579_get_canBeDumped,"flixel.graphics.FlxGraphic","get_canBeDumped",0x9b8a5e36,"flixel.graphics.FlxGraphic.get_canBeDumped","flixel/graphics/FlxGraphic.hx",579,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_584_get_useCount,"flixel.graphics.FlxGraphic","get_useCount",0x2bcc1fb8,"flixel.graphics.FlxGraphic.get_useCount","flixel/graphics/FlxGraphic.hx",584,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_588_set_useCount,"flixel.graphics.FlxGraphic","set_useCount",0x40c5432c,"flixel.graphics.FlxGraphic.set_useCount","flixel/graphics/FlxGraphic.hx",588,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_599_get_destroyOnNoUse,"flixel.graphics.FlxGraphic","get_destroyOnNoUse",0x7e860bbd,"flixel.graphics.FlxGraphic.get_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",599,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_603_set_destroyOnNoUse,"flixel.graphics.FlxGraphic","set_destroyOnNoUse",0x5b353e31,"flixel.graphics.FlxGraphic.set_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",603,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_613_get_imageFrame,"flixel.graphics.FlxGraphic","get_imageFrame",0xc1224382,"flixel.graphics.FlxGraphic.get_imageFrame","flixel/graphics/FlxGraphic.hx",613,0xb3633517)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_153_fromFrame,"flixel.graphics.FlxGraphic","fromFrame",0x19903f5c,"flixel.graphics.FlxGraphic.fromFrame","flixel/graphics/FlxGraphic.hx",153,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_186_fromFrames,"flixel.graphics.FlxGraphic","fromFrames",0x44a73197,"flixel.graphics.FlxGraphic.fromFrames","flixel/graphics/FlxGraphic.hx",186,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_199_fromGraphic,"flixel.graphics.FlxGraphic","fromGraphic",0xf9378b97,"flixel.graphics.FlxGraphic.fromGraphic","flixel/graphics/FlxGraphic.hx",199,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_224_fromRectangle,"flixel.graphics.FlxGraphic","fromRectangle",0x6fce5ede,"flixel.graphics.FlxGraphic.fromRectangle","flixel/graphics/FlxGraphic.hx",224,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_248_getBitmap,"flixel.graphics.FlxGraphic","getBitmap",0xcbe6761e,"flixel.graphics.FlxGraphic.getBitmap","flixel/graphics/FlxGraphic.hx",248,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_261_createGraphic,"flixel.graphics.FlxGraphic","createGraphic",0x3eb28085,"flixel.graphics.FlxGraphic.createGraphic","flixel/graphics/FlxGraphic.hx",261,0xb3633517)
...
HXDLIN( 409)			if (hx::IsNull( this->assetsClass )) {
HXDLIN( 409)				_hx_tmp = hx::IsNotNull( this->assetsKey );
            			}
            			else {
...
HXLINE( 422)		 ::openfl::_legacy::display::BitmapData newBitmap = this->getBitmapFromSystem();
...
HXLINE( 474)		::Array< ::Dynamic> collections;
HXLINE( 475)		{
HXLINE( 475)			int _g = (int)0;
HXDLIN( 475)			::Array< ::Dynamic> _g1 = this->frameCollectionTypes;
HXDLIN( 475)			while((_g < _g1->length)){
HXLINE( 475)				 ::flixel::graphics::frames::FlxFrameCollectionType collectionType = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrameCollectionType >();
...
HXDLIN( 492)		if (hx::IsNotNull( collection->type )) {
HXLINE( 494)			 ::flixel::graphics::frames::FlxFrameCollectionType type = collection->type;
HXDLIN( 494)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(::haxe::IMap_obj::get(this->frameCollections,type)) );
...
HXDLIN( 494)			::cpp::VirtualArray collections1 = collections;
HXLINE( 495)			collections1->push(collection);
            		}
            	}
...
HXLINE( 507)		::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
...
HXLINE( 525)		 ::flixel::graphics::frames::FlxFrame frame =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),null(),null(),null());
HXLINE( 526)		frame->type = (int)2;
HXLINE( 527)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN( 527)		frame->set_frame(rect);
HXLINE( 528)		{
HXLINE( 528)			 ::flixel::math::FlxPoint _this1 = frame->sourceSize;
...
HXLINE( 539)			bool dumped = this->isDumped;
...
HXLINE( 559)		 ::openfl::_legacy::display::BitmapData newBitmap = null();
...
HXLINE( 566)				::String id = this->assetsKey;
...
HXDLIN( 579)		if (hx::IsNull( this->assetsClass )) {
HXDLIN( 579)			return hx::IsNotNull( this->assetsKey );
            		}
            		else {
HXDLIN( 579)			return true;
            		}
...
HXDLIN( 584)		return this->_useCount;
            	}
...
HXDLIN( 599)		return this->_destroyOnNoUse;
            	}
...
HXDLIN( 616)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 616)			_this->x = (int)0;
HXDLIN( 616)			_this->y = (int)0;
HXDLIN( 616)			_this->width = Width;
HXDLIN( 616)			_this->height = Height;
HXDLIN( 616)			 ::flixel::math::FlxRect rect = _this;
HXDLIN( 616)			rect->_inPool = false;
HXDLIN( 616)			this->_imageFrame = ::flixel::graphics::frames::FlxImageFrame_obj::fromRectangle(hx::ObjectPtr<OBJ_>(this),rect);
            		}
...
HXLINE(  39)		 ::openfl::_legacy::display::BitmapData bitmap = null();
HXLINE(  41)		if (!(Cache)) {
...
HXLINE(  51)		::String key = ::flixel::FlxG_obj::bitmap->generateKey(Source,Key,Unique);
HXLINE(  52)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) );
...
HXLINE( 117)		::String key = ::flixel::FlxG_obj::bitmap->findKeyForBitmap(Source);
HXLINE( 119)		::String assetKey = null();
HXLINE( 120)		hx::Class assetClass = null();
HXLINE( 121)		 ::flixel::graphics::FlxGraphic graphic = null();
...
HXLINE( 154)		::String key = Source->name;
HXLINE( 155)		if (hx::IsNull( key )) {
HXLINE( 157)			 ::flixel::math::FlxRect _this = Source->frame;
HXDLIN( 157)			 ::Dynamic value = _this->x;
HXDLIN( 157)			 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 157)			_this1->label = HX_("x",78,00,00,00);
HXDLIN( 157)			_this1->value = value;
HXDLIN( 157)			 ::flixel::util::LabelValuePair key1 = _this1;
HXDLIN( 157)			 ::Dynamic value1 = _this->y;
HXDLIN( 157)			 ::flixel::util::LabelValuePair _this2 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 157)			_this2->label = HX_("y",79,00,00,00);
HXDLIN( 157)			_this2->value = value1;
HXDLIN( 157)			 ::flixel::util::LabelValuePair key2 = _this2;
HXDLIN( 157)			 ::Dynamic value2 = _this->width;
HXDLIN( 157)			 ::flixel::util::LabelValuePair _this3 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 157)			_this3->label = HX_("w",77,00,00,00);
HXDLIN( 157)			_this3->value = value2;
HXDLIN( 157)			 ::flixel::util::LabelValuePair key3 = _this3;
HXDLIN( 157)			 ::Dynamic value3 = _this->height;
HXDLIN( 157)			 ::flixel::util::LabelValuePair _this4 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 157)			_this4->label = HX_("h",68,00,00,00);
HXDLIN( 157)			_this4->value = value3;
HXDLIN( 157)			key = ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,key1)->init(1,key2)->init(2,key3)->init(3,_this4));
            		}
HXLINE( 159)		key = ((Source->parent->key + HX_(":",3a,00,00,00)) + key);
HXLINE( 160)		key = ::flixel::FlxG_obj::bitmap->generateKey(key,Key,Unique);
HXLINE( 161)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) );
HXLINE( 162)		if (hx::IsNotNull( graphic )) {
HXLINE( 164)			return graphic;
            		}
HXLINE( 167)		 ::openfl::_legacy::display::BitmapData bitmap = Source->paint(null(),null(),null(),null());
HXLINE( 168)		graphic = ::flixel::graphics::FlxGraphic_obj::createGraphic(bitmap,key,Unique,Cache);
HXLINE( 169)		 ::flixel::graphics::frames::FlxImageFrame image = ::flixel::graphics::frames::FlxImageFrame_obj::fromGraphic(graphic,null());
...
HXDLIN( 186)		return ::flixel::graphics::FlxGraphic_obj::fromGraphic(Source->parent,Unique,Key);
            	}
...
HXLINE( 205)		::String key = ::flixel::FlxG_obj::bitmap->generateKey(Source->key,Key,Unique);
HXLINE( 206)		 ::flixel::graphics::FlxGraphic graphic = ::flixel::graphics::FlxGraphic_obj::createGraphic(Source->bitmap,key,Unique,null());
...
HXLINE( 225)		::String systemKey = ((((Width + HX_("x",78,00,00,00)) + Height) + HX_(":",3a,00,00,00)) + Color);
HXLINE( 226)		::String key = ::flixel::FlxG_obj::bitmap->generateKey(systemKey,Key,Unique);
HXLINE( 228)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) );
HXLINE( 229)		if (hx::IsNotNull( graphic )) {
HXLINE( 231)			return graphic;
            		}
HXLINE( 234)		 ::openfl::_legacy::display::BitmapData bitmap =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,Width,Height,true,Color,null());
...
HXDLIN( 248)		if (Unique) {
HXDLIN( 248)			return Bitmap->clone();
            		}
            		else {
HXDLIN( 248)			return Bitmap;
            		}
...
HXLINE( 263)		 ::flixel::graphics::FlxGraphic graphic = null();
HXLINE( 265)		if (Cache) {
