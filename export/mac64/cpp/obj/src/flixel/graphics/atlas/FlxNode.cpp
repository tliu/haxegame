...
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_86_destroy,"flixel.graphics.atlas.FlxNode","destroy",0x006100cc,"flixel.graphics.atlas.FlxNode.destroy","flixel/graphics/atlas/FlxNode.hx",86,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_99_canPlace,"flixel.graphics.atlas.FlxNode","canPlace",0xb6bfba85,"flixel.graphics.atlas.FlxNode.canPlace","flixel/graphics/atlas/FlxNode.hx",99,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_110_getTileFrames,"flixel.graphics.atlas.FlxNode","getTileFrames",0xf6655efc,"flixel.graphics.atlas.FlxNode.getTileFrames","flixel/graphics/atlas/FlxNode.hx",110,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_132_getImageFrame,"flixel.graphics.atlas.FlxNode","getImageFrame",0xf79a185a,"flixel.graphics.atlas.FlxNode.getImageFrame","flixel/graphics/atlas/FlxNode.hx",132,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_146_get_isEmpty,"flixel.graphics.atlas.FlxNode","get_isEmpty",0xd9c0632c,"flixel.graphics.atlas.FlxNode.get_isEmpty","flixel/graphics/atlas/FlxNode.hx",146,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_151_get_x,"flixel.graphics.atlas.FlxNode","get_x",0x3d1080a1,"flixel.graphics.atlas.FlxNode.get_x","flixel/graphics/atlas/FlxNode.hx",151,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_156_get_y,"flixel.graphics.atlas.FlxNode","get_y",0x3d1080a2,"flixel.graphics.atlas.FlxNode.get_y","flixel/graphics/atlas/FlxNode.hx",156,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_161_get_width,"flixel.graphics.atlas.FlxNode","get_width",0xb520feaf,"flixel.graphics.atlas.FlxNode.get_width","flixel/graphics/atlas/FlxNode.hx",161,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_165_set_width,"flixel.graphics.atlas.FlxNode","set_width",0x9871eabb,"flixel.graphics.atlas.FlxNode.set_width","flixel/graphics/atlas/FlxNode.hx",165,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_172_get_height,"flixel.graphics.atlas.FlxNode","get_height",0x7e0d531e,"flixel.graphics.atlas.FlxNode.get_height","flixel/graphics/atlas/FlxNode.hx",172,0x6d18bb9f)
HX_LOCAL_STACK_FRAME(_hx_pos_95af95d3889446aa_176_set_height,"flixel.graphics.atlas.FlxNode","set_height",0x818af192,"flixel.graphics.atlas.FlxNode.set_height","flixel/graphics/atlas/FlxNode.hx",176,0x6d18bb9f)
namespace flixel{
namespace graphics{
namespace atlas{
...
HXDLIN(  99)		if ((this->rect->width >= width)) {
HXDLIN(  99)			return (this->rect->height >= height);
            		}
            		else {
...
HXDLIN( 112)		 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(::haxe::IMap_obj::get(_this->framesHash,this->key)) );
HXLINE( 114)		if (hx::IsNotNull( frame )) {
HXLINE( 116)			 ::flixel::graphics::frames::FlxTileFrames tileFrames = ::flixel::graphics::frames::FlxTileFrames_obj::fromFrame(frame,tileSize,tileSpacing);
...
HXDLIN( 134)		 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(::haxe::IMap_obj::get(_this->framesHash,this->key)) );
...
HXDLIN( 146)			_hx_tmp = hx::IsNull( this->left );
            		}
            		else {
HXDLIN( 146)			_hx_tmp = false;
            		}
HXDLIN( 146)		if (_hx_tmp) {
HXDLIN( 146)			return hx::IsNull( this->right );
            		}
            		else {
...
HXDLIN( 151)		return ::Std_obj::_hx_int(this->rect->x);
            	}
...
HXDLIN( 156)		return ::Std_obj::_hx_int(this->rect->y);
            	}
...
HXDLIN( 161)		return ::Std_obj::_hx_int(this->rect->width);
            	}
...
HXDLIN( 172)		return ::Std_obj::_hx_int(this->rect->height);
            	}
