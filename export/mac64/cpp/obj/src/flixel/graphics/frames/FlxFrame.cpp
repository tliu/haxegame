...
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_177_rotateAndFlip,"flixel.graphics.frames.FlxFrame","rotateAndFlip",0x835ac58d,"flixel.graphics.frames.FlxFrame.rotateAndFlip","flixel/graphics/frames/FlxFrame.hx",177,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_226_prepareTransformedBlitMatrix,"flixel.graphics.frames.FlxFrame","prepareTransformedBlitMatrix",0xc5ea2af6,"flixel.graphics.frames.FlxFrame.prepareTransformedBlitMatrix","flixel/graphics/frames/FlxFrame.hx",226,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_241_prepareMatrix,"flixel.graphics.frames.FlxFrame","prepareMatrix",0xbf883cac,"flixel.graphics.frames.FlxFrame.prepareMatrix","flixel/graphics/frames/FlxFrame.hx",241,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_267_fillBlitMatrix,"flixel.graphics.frames.FlxFrame","fillBlitMatrix",0xa3605eb5,"flixel.graphics.frames.FlxFrame.fillBlitMatrix","flixel/graphics/frames/FlxFrame.hx",267,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_287_paint,"flixel.graphics.frames.FlxFrame","paint",0x0c093522,"flixel.graphics.frames.FlxFrame.paint","flixel/graphics/frames/FlxFrame.hx",287,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_332_paintRotatedAndFlipped,"flixel.graphics.frames.FlxFrame","paintRotatedAndFlipped",0x8f0fb1b2,"flixel.graphics.frames.FlxFrame.paintRotatedAndFlipped","flixel/graphics/frames/FlxFrame.hx",332,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_372_checkInputBitmap,"flixel.graphics.frames.FlxFrame","checkInputBitmap",0x11e1b8ad,"flixel.graphics.frames.FlxFrame.checkInputBitmap","flixel/graphics/frames/FlxFrame.hx",372,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_409_getDrawFrameRect,"flixel.graphics.frames.FlxFrame","getDrawFrameRect",0x7930f1d3,"flixel.graphics.frames.FlxFrame.getDrawFrameRect","flixel/graphics/frames/FlxFrame.hx",409,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_430_subFrameTo,"flixel.graphics.frames.FlxFrame","subFrameTo",0x37199964,"flixel.graphics.frames.FlxFrame.subFrameTo","flixel/graphics/frames/FlxFrame.hx",430,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_518_setBorderTo,"flixel.graphics.frames.FlxFrame","setBorderTo",0x0ba0ebcd,"flixel.graphics.frames.FlxFrame.setBorderTo","flixel/graphics/frames/FlxFrame.hx",518,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_533_clipTo,"flixel.graphics.frames.FlxFrame","clipTo",0x9ecb6267,"flixel.graphics.frames.FlxFrame.clipTo","flixel/graphics/frames/FlxFrame.hx",533,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_618_copyTo,"flixel.graphics.frames.FlxFrame","copyTo",0x5da6728c,"flixel.graphics.frames.FlxFrame.copyTo","flixel/graphics/frames/FlxFrame.hx",618,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_642_destroy,"flixel.graphics.frames.FlxFrame","destroy",0x74fe137e,"flixel.graphics.frames.FlxFrame.destroy","flixel/graphics/frames/FlxFrame.hx",642,0x6c7f608b)
HX_LOCAL_STACK_FRAME(_hx_pos_5df8bdd839d6a258_658_toString,"flixel.graphics.frames.FlxFrame","toString",0x50e09da8,"flixel.graphics.frames.FlxFrame.toString","flixel/graphics/frames/FlxFrame.hx",658,0x6c7f608b)
...
HXLINE( 102)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 102)		point->_inPool = false;
HXDLIN( 102)		this->sourceSize = point;
HXLINE( 103)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 103)		point1->_inPool = false;
HXDLIN( 103)		this->offset = point1;
HXLINE( 105)		::Array< Float > this1 = ::Array_obj< Float >::__new((int)6);
HXDLIN( 105)		this->blitMatrix = this1;
HXLINE( 106)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 108)			::Array< Float > this2 = ::Array_obj< Float >::__new((int)6);
...
HXLINE( 178)		int w = ::Std_obj::_hx_int(this->sourceSize->x);
HXLINE( 179)		int h = ::Std_obj::_hx_int(this->sourceSize->y);
...
HXDLIN( 227)		mat = mat;
HXLINE( 228)		int w = ::Std_obj::_hx_int(this->sourceSize->x);
HXDLIN( 228)		int h = ::Std_obj::_hx_int(this->sourceSize->y);
...
HXLINE( 255)		bool doFlipX = (flipX != this->flipX);
HXLINE( 256)		bool doFlipY = (flipY != this->flipY);
...
HXLINE( 263)		int w = ::Std_obj::_hx_int(this->sourceSize->x);
HXDLIN( 263)		int h = ::Std_obj::_hx_int(this->sourceSize->y);
...
HXLINE( 294)		 ::openfl::_legacy::display::BitmapData bmd1 = bmd;
HXDLIN( 294)		int w = ::Std_obj::_hx_int(this->sourceSize->x);
HXDLIN( 294)		int h = ::Std_obj::_hx_int(this->sourceSize->y);
HXDLIN( 294)		if (((int)0 != (int)0)) {
HXLINE( 294)			int t = w;
HXDLIN( 294)			w = h;
HXDLIN( 294)			h = t;
            		}
...
HXDLIN( 303)				 ::openfl::_legacy::geom::Point FlashPoint = this->point2;
...
HXLINE( 306)			 ::openfl::_legacy::display::BitmapData _hx_tmp2 = this->parent->bitmap;
HXDLIN( 306)			 ::flixel::math::FlxRect _this1 = this->frame;
HXDLIN( 306)			 ::openfl::_legacy::geom::Rectangle FlashRect = this->rect;
...
HXDLIN( 312)			{
HXLINE( 312)				 ::openfl::_legacy::geom::Rectangle FlashRect1 = this->rect;
...
HXDLIN( 312)			 ::openfl::_legacy::geom::Rectangle rect1 = this->rect;
...
HXLINE( 344)		 ::openfl::_legacy::display::BitmapData bmd1 = bmd;
HXDLIN( 344)		int w = ::Std_obj::_hx_int(this->sourceSize->x);
HXDLIN( 344)		int h = ::Std_obj::_hx_int(this->sourceSize->y);
...
HXDLIN( 356)		{
HXLINE( 356)			 ::openfl::_legacy::geom::Rectangle FlashRect = this->rect;
...
HXDLIN( 356)		 ::openfl::_legacy::geom::Rectangle rect1 = this->rect;
...
HXLINE( 373)		int w = ::Std_obj::_hx_int(this->sourceSize->x);
HXLINE( 374)		int h = ::Std_obj::_hx_int(this->sourceSize->y);
...
HXDLIN( 410)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 410)		point->_inPool = false;
HXDLIN( 410)		 ::flixel::math::FlxPoint point1 = point;
HXDLIN( 410)		point1->_weak = true;
HXDLIN( 410)		 ::flixel::math::FlxPoint p1 = point1;
HXLINE( 411)		 ::flixel::math::FlxRect _this = this->frame;
HXDLIN( 411)		Float X1 = (_this->x + _this->width);
HXDLIN( 411)		 ::flixel::math::FlxRect _this1 = this->frame;
HXDLIN( 411)		Float Y1 = (_this1->y + _this1->height);
HXDLIN( 411)		 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(X1,Y1);
HXDLIN( 411)		point2->_inPool = false;
HXDLIN( 411)		 ::flixel::math::FlxPoint point3 = point2;
HXDLIN( 411)		point3->_weak = true;
HXDLIN( 411)		 ::flixel::math::FlxPoint p2 = point3;
HXLINE( 413)		{
HXLINE( 413)			Float x1 = (p1->x * mat->a);
HXDLIN( 413)			Float x11 = ((x1 + (p1->y * mat->c)) + mat->tx);
HXDLIN( 413)			Float y1 = (p1->x * mat->b);
HXDLIN( 413)			Float y11 = ((y1 + (p1->y * mat->d)) + mat->ty);
HXDLIN( 413)			p1->set(x11,y11);
            		}
HXLINE( 414)		{
HXLINE( 414)			Float x12 = (p2->x * mat->a);
HXDLIN( 414)			Float x13 = ((x12 + (p2->y * mat->c)) + mat->tx);
HXDLIN( 414)			Float y12 = (p2->x * mat->b);
HXDLIN( 414)			Float y13 = ((y12 + (p2->y * mat->d)) + mat->ty);
HXDLIN( 414)			p2->set(x13,y13);
            		}
HXLINE( 416)		 ::flixel::math::FlxRect _this2 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 416)		_this2->x = (int)0;
HXDLIN( 416)		_this2->y = (int)0;
HXDLIN( 416)		_this2->width = (int)0;
HXDLIN( 416)		_this2->height = (int)0;
HXDLIN( 416)		 ::flixel::math::FlxRect rect = _this2;
HXDLIN( 416)		rect->_inPool = false;
HXDLIN( 416)		 ::flixel::math::FlxRect _this3 = rect;
HXDLIN( 416)		Float minX = ::Math_obj::min(p1->x,p2->x);
HXDLIN( 416)		Float minY = ::Math_obj::min(p1->y,p2->y);
HXDLIN( 416)		Float maxX = ::Math_obj::max(p1->x,p2->x);
HXDLIN( 416)		Float maxY = ::Math_obj::max(p1->y,p2->y);
HXDLIN( 416)		if (p1->_weak) {
HXLINE( 416)			p1->put();
            		}
HXDLIN( 416)		if (p2->_weak) {
HXLINE( 416)			p2->put();
            		}
HXDLIN( 416)		_this3->x = minX;
HXDLIN( 416)		_this3->y = minY;
HXDLIN( 416)		_this3->width = (maxX - minX);
HXDLIN( 416)		_this3->height = (maxY - minY);
HXDLIN( 416)		 ::flixel::math::FlxRect flxRect = _this3;
HXLINE( 417)		{
HXLINE( 417)			 ::openfl::_legacy::geom::Rectangle FlashRect = this->rect;
...
HXDLIN( 417)			FlashRect->x = flxRect->x;
HXDLIN( 417)			FlashRect->y = flxRect->y;
HXDLIN( 417)			FlashRect->width = flxRect->width;
HXDLIN( 417)			FlashRect->height = flxRect->height;
            		}
HXLINE( 418)		if (!(flxRect->_inPool)) {
HXLINE( 418)			flxRect->_inPool = true;
HXDLIN( 418)			flxRect->_weak = false;
HXDLIN( 418)			::flixel::math::FlxRect_obj::_pool->putUnsafe(flxRect);
            		}
...
HXDLIN( 452)		 ::flixel::math::FlxRect rect1 = _this;
HXDLIN( 452)		rect1->_inPool = false;
HXDLIN( 452)		 ::flixel::math::FlxRect _this1 = rect1;
HXDLIN( 452)		_this1->width = this->frame->width;
HXDLIN( 452)		_this1->height = this->frame->height;
HXDLIN( 452)		 ::flixel::math::FlxRect clippedRect = _this1;
HXLINE( 453)		if ((this->angle != (int)0)) {
HXLINE( 455)			clippedRect->width = this->frame->height;
HXLINE( 456)			clippedRect->height = this->frame->width;
            		}
HXLINE( 459)		Float ox = ::Math_obj::max(this->offset->x,(int)0);
HXLINE( 460)		Float oy = ::Math_obj::max(this->offset->y,(int)0);
HXLINE( 462)		{
HXLINE( 462)			 ::flixel::math::FlxRect rect2 = rect;
HXDLIN( 462)			rect2->x = (rect2->x + -(ox));
HXDLIN( 462)			 ::flixel::math::FlxRect rect3 = rect;
HXDLIN( 462)			rect3->y = (rect3->y + -(oy));
            		}
HXLINE( 463)		 ::flixel::math::FlxRect frameRect = clippedRect->intersection(rect,null());
HXLINE( 464)		clippedRect = ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(clippedRect)) );
HXLINE( 465)		{
HXLINE( 465)			 ::flixel::math::FlxRect rect4 = rect;
HXDLIN( 465)			rect4->x = (rect4->x + ox);
HXDLIN( 465)			 ::flixel::math::FlxRect rect5 = rect;
HXDLIN( 465)			rect5->y = (rect5->y + oy);
            		}
...
HXLINE( 477)			 ::flixel::math::FlxPoint _this2 = frameToFill->offset->set(frameRect->x,frameRect->y);
HXDLIN( 477)			Float Y = rect->y;
HXDLIN( 477)			{
HXLINE( 477)				 ::flixel::math::FlxPoint _g = _this2;
HXDLIN( 477)				_g->set_x((_g->x - rect->x));
            			}
HXDLIN( 477)			{
HXLINE( 477)				 ::flixel::math::FlxPoint _g1 = _this2;
HXDLIN( 477)				_g1->set_y((_g1->y - Y));
            			}
HXDLIN( 477)			_this2->addPoint(this->offset);
HXLINE( 479)			Float X = frameRect->x;
HXDLIN( 479)			Float Y1 = frameRect->y;
HXDLIN( 479)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y1);
HXDLIN( 479)			point->_inPool = false;
HXDLIN( 479)			 ::flixel::math::FlxPoint point1 = point;
HXDLIN( 479)			point1->_weak = true;
HXDLIN( 479)			 ::flixel::math::FlxPoint p1 = point1;
HXLINE( 480)			Float X1 = (frameRect->x + frameRect->width);
HXDLIN( 480)			Float Y2 = (frameRect->y + frameRect->height);
HXDLIN( 480)			 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(X1,Y2);
HXDLIN( 480)			point2->_inPool = false;
HXDLIN( 480)			 ::flixel::math::FlxPoint point3 = point2;
HXDLIN( 480)			point3->_weak = true;
HXDLIN( 480)			 ::flixel::math::FlxPoint p2 = point3;
HXLINE( 482)			this->matrix->identity();
HXLINE( 484)			if ((this->angle == (int)-90)) {
HXLINE( 486)				{
HXLINE( 486)					 ::flixel::math::FlxMatrix _this3 = this->matrix;
HXDLIN( 486)					_this3->setTo(-(_this3->b),_this3->a,-(_this3->d),_this3->c,-(_this3->ty),_this3->tx);
            				}
...
HXLINE( 491)					{
HXLINE( 491)						 ::flixel::math::FlxMatrix _this4 = this->matrix;
HXDLIN( 491)						_this4->setTo(_this4->b,-(_this4->a),_this4->d,-(_this4->c),_this4->ty,-(_this4->tx));
            					}
...
HXLINE( 497)				{
HXLINE( 497)					 ::openfl::_legacy::geom::Matrix matrix = this->matrix;
HXDLIN( 497)					Float x1 = (p1->x * matrix->a);
HXDLIN( 497)					Float x11 = ((x1 + (p1->y * matrix->c)) + matrix->tx);
HXDLIN( 497)					Float y1 = (p1->x * matrix->b);
HXDLIN( 497)					Float y11 = ((y1 + (p1->y * matrix->d)) + matrix->ty);
HXDLIN( 497)					p1->set(x11,y11);
            				}
HXLINE( 498)				{
HXLINE( 498)					 ::openfl::_legacy::geom::Matrix matrix1 = this->matrix;
HXDLIN( 498)					Float x12 = (p2->x * matrix1->a);
HXDLIN( 498)					Float x13 = ((x12 + (p2->y * matrix1->c)) + matrix1->tx);
HXDLIN( 498)					Float y12 = (p2->x * matrix1->b);
HXDLIN( 498)					Float y13 = ((y12 + (p2->y * matrix1->d)) + matrix1->ty);
HXDLIN( 498)					p2->set(x13,y13);
            				}
            			}
HXLINE( 501)			{
HXLINE( 501)				Float minX = ::Math_obj::min(p1->x,p2->x);
HXDLIN( 501)				Float minY = ::Math_obj::min(p1->y,p2->y);
HXDLIN( 501)				Float maxX = ::Math_obj::max(p1->x,p2->x);
HXDLIN( 501)				Float maxY = ::Math_obj::max(p1->y,p2->y);
HXDLIN( 501)				if (p1->_weak) {
HXLINE( 501)					p1->put();
            				}
HXDLIN( 501)				if (p2->_weak) {
HXLINE( 501)					p2->put();
            				}
HXDLIN( 501)				{
...
HXLINE( 502)			{
HXLINE( 502)				 ::flixel::math::FlxRect frameRect1 = frameRect;
HXDLIN( 502)				frameRect1->x = (frameRect1->x + this->frame->x);
HXDLIN( 502)				 ::flixel::math::FlxRect frameRect2 = frameRect;
HXDLIN( 502)				frameRect2->y = (frameRect2->y + this->frame->y);
            			}
...
HXDLIN( 519)		Float Width = this->sourceSize->x;
HXDLIN( 519)		Float Width1 = (Width - ((int)2 * border->x));
HXDLIN( 519)		Float Height = this->sourceSize->y;
HXDLIN( 519)		Float Height1 = (Height - ((int)2 * border->y));
HXDLIN( 519)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 519)		_this->x = X;
HXDLIN( 519)		_this->y = Y;
HXDLIN( 519)		_this->width = Width1;
HXDLIN( 519)		_this->height = Height1;
HXDLIN( 519)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 519)		rect->_inPool = false;
HXDLIN( 519)		 ::flixel::math::FlxRect rect1 = rect;
HXLINE( 520)		frameToFill = this->subFrameTo(rect1,frameToFill);
HXLINE( 521)		frameToFill->name = this->name;
HXLINE( 522)		rect1 = ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(rect1)) );
...
HXLINE( 545)		{
HXLINE( 545)			 ::flixel::math::FlxPoint _this = clippedFrame->sourceSize;
HXDLIN( 545)			 ::flixel::math::FlxPoint point = this->sourceSize;
...
HXLINE( 556)		 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 556)		_this1->x = (int)0;
HXDLIN( 556)		_this1->y = (int)0;
HXDLIN( 556)		_this1->width = (int)0;
HXDLIN( 556)		_this1->height = (int)0;
HXDLIN( 556)		 ::flixel::math::FlxRect rect = _this1;
HXDLIN( 556)		rect->_inPool = false;
HXDLIN( 556)		 ::flixel::math::FlxRect _this2 = rect;
HXDLIN( 556)		_this2->width = this->frame->width;
HXDLIN( 556)		_this2->height = this->frame->height;
HXDLIN( 556)		 ::flixel::math::FlxRect clippedRect = _this2;
HXLINE( 557)		if ((this->angle != (int)0)) {
HXLINE( 559)			clippedRect->width = this->frame->height;
HXLINE( 560)			clippedRect->height = this->frame->width;
            		}
HXLINE( 563)		{
HXLINE( 563)			 ::flixel::math::FlxRect clip1 = clip;
HXDLIN( 563)			clip1->x = (clip1->x + -(this->offset->x));
HXDLIN( 563)			 ::flixel::math::FlxRect clip2 = clip;
HXDLIN( 563)			clip2->y = (clip2->y + -(this->offset->y));
            		}
HXLINE( 564)		 ::flixel::math::FlxRect frameRect = clippedRect->intersection(clip,null());
HXLINE( 565)		clippedRect = ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(clippedRect)) );
...
HXDLIN( 579)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 579)			point1->_inPool = false;
HXDLIN( 579)			 ::flixel::math::FlxPoint point2 = point1;
HXDLIN( 579)			point2->_weak = true;
HXDLIN( 579)			 ::flixel::math::FlxPoint p1 = point2;
HXLINE( 580)			Float X1 = (frameRect->x + frameRect->width);
HXDLIN( 580)			Float Y1 = (frameRect->y + frameRect->height);
HXDLIN( 580)			 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set(X1,Y1);
HXDLIN( 580)			point3->_inPool = false;
HXDLIN( 580)			 ::flixel::math::FlxPoint point4 = point3;
HXDLIN( 580)			point4->_weak = true;
HXDLIN( 580)			 ::flixel::math::FlxPoint p2 = point4;
HXLINE( 582)			this->matrix->identity();
HXLINE( 584)			if ((this->angle == (int)-90)) {
HXLINE( 586)				{
HXLINE( 586)					 ::flixel::math::FlxMatrix _this3 = this->matrix;
HXDLIN( 586)					_this3->setTo(-(_this3->b),_this3->a,-(_this3->d),_this3->c,-(_this3->ty),_this3->tx);
            				}
...
HXLINE( 591)					{
HXLINE( 591)						 ::flixel::math::FlxMatrix _this4 = this->matrix;
HXDLIN( 591)						_this4->setTo(_this4->b,-(_this4->a),_this4->d,-(_this4->c),_this4->ty,-(_this4->tx));
            					}
...
HXLINE( 597)				{
HXLINE( 597)					 ::openfl::_legacy::geom::Matrix matrix = this->matrix;
HXDLIN( 597)					Float x1 = (p1->x * matrix->a);
HXDLIN( 597)					Float x11 = ((x1 + (p1->y * matrix->c)) + matrix->tx);
HXDLIN( 597)					Float y1 = (p1->x * matrix->b);
HXDLIN( 597)					Float y11 = ((y1 + (p1->y * matrix->d)) + matrix->ty);
HXDLIN( 597)					p1->set(x11,y11);
            				}
HXLINE( 598)				{
HXLINE( 598)					 ::openfl::_legacy::geom::Matrix matrix1 = this->matrix;
HXDLIN( 598)					Float x12 = (p2->x * matrix1->a);
HXDLIN( 598)					Float x13 = ((x12 + (p2->y * matrix1->c)) + matrix1->tx);
HXDLIN( 598)					Float y12 = (p2->x * matrix1->b);
HXDLIN( 598)					Float y13 = ((y12 + (p2->y * matrix1->d)) + matrix1->ty);
HXDLIN( 598)					p2->set(x13,y13);
            				}
            			}
HXLINE( 601)			{
HXLINE( 601)				Float minX = ::Math_obj::min(p1->x,p2->x);
HXDLIN( 601)				Float minY = ::Math_obj::min(p1->y,p2->y);
HXDLIN( 601)				Float maxX = ::Math_obj::max(p1->x,p2->x);
HXDLIN( 601)				Float maxY = ::Math_obj::max(p1->y,p2->y);
HXDLIN( 601)				if (p1->_weak) {
HXLINE( 601)					p1->put();
            				}
HXDLIN( 601)				if (p2->_weak) {
HXLINE( 601)					p2->put();
            				}
HXDLIN( 601)				{
...
HXLINE( 602)			{
HXLINE( 602)				 ::flixel::math::FlxRect frameRect1 = frameRect;
HXDLIN( 602)				frameRect1->x = (frameRect1->x + this->frame->x);
HXDLIN( 602)				 ::flixel::math::FlxRect frameRect2 = frameRect;
HXDLIN( 602)				frameRect2->y = (frameRect2->y + this->frame->y);
            			}
HXLINE( 603)			clippedFrame->set_frame(frameRect);
HXLINE( 604)			clippedFrame->cacheFrameMatrix();
            		}
HXLINE( 607)		{
HXLINE( 607)			 ::flixel::math::FlxRect clip3 = clip;
HXDLIN( 607)			clip3->x = (clip3->x + this->offset->x);
HXDLIN( 607)			 ::flixel::math::FlxRect clip4 = clip;
HXDLIN( 607)			clip4->y = (clip4->y + this->offset->y);
            		}
...
HXLINE( 630)		{
HXLINE( 630)			 ::flixel::math::FlxPoint _this = clone->offset;
HXDLIN( 630)			 ::flixel::math::FlxPoint point = this->offset;
...
HXLINE( 633)		{
HXLINE( 633)			 ::flixel::math::FlxPoint _this1 = clone->sourceSize;
HXDLIN( 633)			 ::flixel::math::FlxPoint point1 = this->sourceSize;
...
HXLINE( 634)		 ::flixel::math::FlxRect _this2 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 634)		_this2->x = (int)0;
HXDLIN( 634)		_this2->y = (int)0;
HXDLIN( 634)		_this2->width = (int)0;
HXDLIN( 634)		_this2->height = (int)0;
HXDLIN( 634)		 ::flixel::math::FlxRect rect = _this2;
HXDLIN( 634)		rect->_inPool = false;
HXDLIN( 634)		 ::flixel::math::FlxRect _this3 = rect;
HXDLIN( 634)		 ::flixel::math::FlxRect Rect = this->frame;
HXDLIN( 634)		_this3->x = Rect->x;
HXDLIN( 634)		_this3->y = Rect->y;
HXDLIN( 634)		_this3->width = Rect->width;
HXDLIN( 634)		_this3->height = Rect->height;
...
HXDLIN( 634)		clone->set_frame(_this3);
