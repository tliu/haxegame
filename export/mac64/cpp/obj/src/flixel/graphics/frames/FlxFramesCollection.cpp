...
HXDLIN(  75)		return this->framesHash->get(name).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
            	}
...
HXDLIN(  86)		return this->frames->__get(index).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
            	}
...
HXDLIN( 116)		return this->frames->indexOf(frame,null());
            	}
...
HXDLIN( 245)		HX_STACK_DO_THROW(HX_("To be overriden in subclasses",8b,78,89,60));
...
HXDLIN( 258)		return this->frames->length;
            	}
