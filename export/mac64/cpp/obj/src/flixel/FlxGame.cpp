...
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_286_setFilters,"flixel.FlxGame","setFilters",0x71579bd5,"flixel.FlxGame.setFilters","flixel/FlxGame.hx",286,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_293_create,"flixel.FlxGame","create",0x90873e98,"flixel.FlxGame.create","flixel/FlxGame.hx",293,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_371_onFocus,"flixel.FlxGame","onFocus",0x6f2bcf1d,"flixel.FlxGame.onFocus","flixel/FlxGame.hx",371,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_421_onFocusLost,"flixel.FlxGame","onFocusLost",0xb7eef7a1,"flixel.FlxGame.onFocusLost","flixel/FlxGame.hx",421,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_458_onResize,"flixel.FlxGame","onResize",0xebfa470f,"flixel.FlxGame.onResize","flixel/FlxGame.hx",458,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_473_resizeGame,"flixel.FlxGame","resizeGame",0xcdcb59a2,"flixel.FlxGame.resizeGame","flixel/FlxGame.hx",473,0x34f39fed)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_581_resetGame,"flixel.FlxGame","resetGame",0xde30cf45,"flixel.FlxGame.resetGame","flixel/FlxGame.hx",581,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_621_switchState,"flixel.FlxGame","switchState",0xedf41a61,"flixel.FlxGame.switchState","flixel/FlxGame.hx",621,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_662_gameStart,"flixel.FlxGame","gameStart",0x0d0c34f4,"flixel.FlxGame.gameStart","flixel/FlxGame.hx",662,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_674_step,"flixel.FlxGame","step",0xd28f5fe8,"flixel.FlxGame.step","flixel/FlxGame.hx",674,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_697_handleReplayRequests,"flixel.FlxGame","handleReplayRequests",0xefa2c6ef,"flixel.FlxGame.handleReplayRequests","flixel/FlxGame.hx",697,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_731_update,"flixel.FlxGame","update",0x9b7d5da5,"flixel.FlxGame.update","flixel/FlxGame.hx",731,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_783_updateElapsed,"flixel.FlxGame","updateElapsed",0x372d9117,"flixel.FlxGame.updateElapsed","flixel/FlxGame.hx",783,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_842_updateInput,"flixel.FlxGame","updateInput",0x1a1f4025,"flixel.FlxGame.updateInput","flixel/FlxGame.hx",842,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_861_draw,"flixel.FlxGame","draw",0xc8a3a4a0,"flixel.FlxGame.draw","flixel/FlxGame.hx",861,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_912_getTicks,"flixel.FlxGame","getTicks",0x73d7349c,"flixel.FlxGame.getTicks","flixel/FlxGame.hx",912,0x34f39fed)
HX_LOCAL_STACK_FRAME(_hx_pos_ad2b8ce2bfb1aa86_918___default_getTimer,"flixel.FlxGame","__default_getTimer",0xda03b289,"flixel.FlxGame.__default_getTimer","flixel/FlxGame.hx",918,0x34f39fed)
namespace flixel{
...
HXDLIN( 286)		this->_filters = filters;
            	}
...
HXLINE( 354)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
            		}
...
HXLINE( 365)		int _hx_tmp2 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
HXDLIN( 365)		this->resizeGame(_hx_tmp2,::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight());
...
HXDLIN( 417)			::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::inputs->list;
HXDLIN( 417)			while((_g < _g1->length)){
HXLINE( 417)				::Dynamic input = _g1->__get(_g);
...
HXLINE( 453)		{
HXLINE( 453)			int _g = (int)0;
HXDLIN( 453)			::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::inputs->list;
HXDLIN( 453)			while((_g < _g1->length)){
HXLINE( 453)				::Dynamic input = _g1->__get(_g);
...
HXLINE( 459)		int width = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
HXLINE( 460)		int height = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight();
...
HXLINE( 500)		{
HXLINE( 500)			int _g = (int)0;
HXDLIN( 500)			::Array< ::Dynamic> _g1 = this->postProcesses;
HXDLIN( 500)			while((_g < _g1->length)){
HXLINE( 500)				 ::flixel::effects::postprocess::PostProcess postProcess = _g1->__get(_g).StaticCast<  ::flixel::effects::postprocess::PostProcess >();
...
HXLINE( 763)		{
HXLINE( 763)			Float elapsed = ::flixel::FlxG_obj::elapsed;
HXDLIN( 763)			{
HXLINE( 763)				int _g = (int)0;
HXDLIN( 763)				::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::plugins->list;
HXDLIN( 763)				while((_g < _g1->length)){
HXLINE( 763)					 ::flixel::FlxBasic plugin = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
...
HXLINE( 767)		{
HXLINE( 767)			Float elapsed1 = ::flixel::FlxG_obj::elapsed;
HXDLIN( 767)			{
HXLINE( 767)				int _g2 = (int)0;
HXDLIN( 767)				::Array< ::Dynamic> _g11 = ::flixel::FlxG_obj::cameras->list;
HXDLIN( 767)				while((_g2 < _g11->length)){
HXLINE( 767)					 ::flixel::FlxCamera camera = _g11->__get(_g2).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 778)		this->set_filters(_hx_tmp4);
            	}
...
HXDLIN( 783)		if (::flixel::FlxG_obj::fixedTimestep) {
HXLINE( 785)			::flixel::FlxG_obj::elapsed = (::flixel::FlxG_obj::timeScale * this->_stepSeconds);
            		}
            		else {
HXLINE( 789)			Float _hx_tmp = ::flixel::FlxG_obj::timeScale;
HXDLIN( 789)			::flixel::FlxG_obj::elapsed = (_hx_tmp * ((Float)this->_elapsedMS / (Float)(int)1000));
HXLINE( 791)			Float max = (::flixel::FlxG_obj::maxElapsed * ::flixel::FlxG_obj::timeScale);
...
HXDLIN( 842)		::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::inputs->list;
HXDLIN( 842)		while((_g < _g1->length)){
HXDLIN( 842)			::Dynamic input = _g1->__get(_g);
...
HXLINE( 886)		{
HXLINE( 886)			 ::flixel::_hx_system::frontEnds::CameraFrontEnd _this = ::flixel::FlxG_obj::cameras;
HXDLIN( 886)			{
HXLINE( 886)				int _g = (int)0;
HXDLIN( 886)				::Array< ::Dynamic> _g1 = _this->list;
...
HXLINE( 888)		{
HXLINE( 888)			int _g2 = (int)0;
HXDLIN( 888)			::Array< ::Dynamic> _g11 = ::flixel::FlxG_obj::plugins->list;
HXDLIN( 888)			while((_g2 < _g11->length)){
HXLINE( 888)				 ::flixel::FlxBasic plugin = _g11->__get(_g2).StaticCast<  ::flixel::FlxBasic >();
...
HXLINE( 894)				int _g3 = (int)0;
HXDLIN( 894)				::Array< ::Dynamic> _g12 = ::flixel::FlxG_obj::cameras->list;
HXDLIN( 894)				while((_g3 < _g12->length)){
HXLINE( 894)					 ::flixel::FlxCamera camera1 = _g12->__get(_g3).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 901)		{
HXLINE( 901)			 ::flixel::_hx_system::frontEnds::CameraFrontEnd _this1 = ::flixel::FlxG_obj::cameras;
HXDLIN( 901)			{
HXLINE( 901)				int _g4 = (int)0;
HXDLIN( 901)				::Array< ::Dynamic> _g13 = _this1->list;
HXDLIN( 901)				while((_g4 < _g13->length)){
HXLINE( 901)					 ::flixel::FlxCamera camera2 = _g13->__get(_g4).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 912)		int _hx_tmp = ( (int)(this->getTimer()) );
...
HXDLIN( 918)		return ::openfl::_legacy::Lib_obj::getTimer();
            	}
