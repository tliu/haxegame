...
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_124_flash,"flixel.system.frontEnds.CameraFrontEnd","flash",0x12371db3,"flixel.system.frontEnds.CameraFrontEnd.flash","flixel/system/frontEnds/CameraFrontEnd.hx",124,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_141_fade,"flixel.system.frontEnds.CameraFrontEnd","fade",0x4aaafed9,"flixel.system.frontEnds.CameraFrontEnd.fade","flixel/system/frontEnds/CameraFrontEnd.hx",141,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_158_shake,"flixel.system.frontEnds.CameraFrontEnd","shake",0x8bc7c6c9,"flixel.system.frontEnds.CameraFrontEnd.shake","flixel/system/frontEnds/CameraFrontEnd.hx",158,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_176_lock,"flixel.system.frontEnds.CameraFrontEnd","lock",0x4eace548,"flixel.system.frontEnds.CameraFrontEnd.lock","flixel/system/frontEnds/CameraFrontEnd.hx",176,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_218_render,"flixel.system.frontEnds.CameraFrontEnd","render",0xab0985f3,"flixel.system.frontEnds.CameraFrontEnd.render","flixel/system/frontEnds/CameraFrontEnd.hx",218,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_236_unlock,"flixel.system.frontEnds.CameraFrontEnd","unlock",0x0b6cbd61,"flixel.system.frontEnds.CameraFrontEnd.unlock","flixel/system/frontEnds/CameraFrontEnd.hx",236,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_263_update,"flixel.system.frontEnds.CameraFrontEnd","update",0x2ce5a0a6,"flixel.system.frontEnds.CameraFrontEnd.update","flixel/system/frontEnds/CameraFrontEnd.hx",263,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_278_resize,"flixel.system.frontEnds.CameraFrontEnd","resize",0xae5b7491,"flixel.system.frontEnds.CameraFrontEnd.resize","flixel/system/frontEnds/CameraFrontEnd.hx",278,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_286_get_bgColor,"flixel.system.frontEnds.CameraFrontEnd","get_bgColor",0x99072db8,"flixel.system.frontEnds.CameraFrontEnd.get_bgColor","flixel/system/frontEnds/CameraFrontEnd.hx",286,0x7a57d3ec)
HX_LOCAL_STACK_FRAME(_hx_pos_37a8fd7f84c9d590_290_set_bgColor,"flixel.system.frontEnds.CameraFrontEnd","set_bgColor",0xa37434c4,"flixel.system.frontEnds.CameraFrontEnd.set_bgColor","flixel/system/frontEnds/CameraFrontEnd.hx",290,0x7a57d3ec)
namespace flixel{
...
HXLINE( 100)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 124)		int _g = (int)0;
HXDLIN( 124)		::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 124)		while((_g < _g1->length)){
HXDLIN( 124)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 141)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 158)		int _g = (int)0;
HXDLIN( 158)		::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 158)		while((_g < _g1->length)){
HXDLIN( 158)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 176)		int _g = (int)0;
HXDLIN( 176)		::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 176)		while((_g < _g1->length)){
HXDLIN( 176)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 218)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 220)			int _g = (int)0;
HXDLIN( 220)			::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 220)			while((_g < _g1->length)){
HXLINE( 220)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 236)		::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 236)		while((_g < _g1->length)){
HXDLIN( 236)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 263)		int _g = (int)0;
HXDLIN( 263)		::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 263)		while((_g < _g1->length)){
HXDLIN( 263)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 278)		int _g = (int)0;
HXDLIN( 278)		::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 278)		while((_g < _g1->length)){
HXDLIN( 278)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXDLIN( 286)		if (hx::IsNull( ::flixel::FlxG_obj::camera )) {
HXDLIN( 286)			return (int)-16777216;
            		}
            		else {
HXDLIN( 286)			return ::flixel::FlxG_obj::camera->bgColor;
            		}
...
HXDLIN( 291)			::Array< ::Dynamic> _g1 = this->list;
