...
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_302_removeByKey,"flixel.system.frontEnds.BitmapFrontEnd","removeByKey",0x593bffb1,"flixel.system.frontEnds.BitmapFrontEnd.removeByKey","flixel/system/frontEnds/BitmapFrontEnd.hx",302,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_313_removeIfNoUse,"flixel.system.frontEnds.BitmapFrontEnd","removeIfNoUse",0x6b036552,"flixel.system.frontEnds.BitmapFrontEnd.removeIfNoUse","flixel/system/frontEnds/BitmapFrontEnd.hx",313,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_322_clearCache,"flixel.system.frontEnds.BitmapFrontEnd","clearCache",0xad367388,"flixel.system.frontEnds.BitmapFrontEnd.clearCache","flixel/system/frontEnds/BitmapFrontEnd.hx",322,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_340_reset,"flixel.system.frontEnds.BitmapFrontEnd","reset",0xd15ce89c,"flixel.system.frontEnds.BitmapFrontEnd.reset","flixel/system/frontEnds/BitmapFrontEnd.hx",340,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_360_clearUnused,"flixel.system.frontEnds.BitmapFrontEnd","clearUnused",0x9cfedd10,"flixel.system.frontEnds.BitmapFrontEnd.clearUnused","flixel/system/frontEnds/BitmapFrontEnd.hx",360,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_373_get_maxTextureSize,"flixel.system.frontEnds.BitmapFrontEnd","get_maxTextureSize",0x8d42ecd4,"flixel.system.frontEnds.BitmapFrontEnd.get_maxTextureSize","flixel/system/frontEnds/BitmapFrontEnd.hx",373,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_378_get_whitePixel,"flixel.system.frontEnds.BitmapFrontEnd","get_whitePixel",0xa476cef9,"flixel.system.frontEnds.BitmapFrontEnd.get_whitePixel","flixel/system/frontEnds/BitmapFrontEnd.hx",378,0x91a05ae2)
namespace flixel{
...
HXDLIN( 302)			_hx_tmp = this->_cache->exists(key);
            		}
            		else {
HXDLIN( 302)			_hx_tmp = false;
            		}
HXDLIN( 302)		if (_hx_tmp) {
HXLINE( 304)			 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXDLIN( 313)			_hx_tmp1 = (graphic->get_useCount() == (int)0);
            		}
            		else {
HXDLIN( 313)			_hx_tmp1 = false;
            		}
HXDLIN( 313)		if (_hx_tmp1) {
HXDLIN( 313)			_hx_tmp = !(graphic->persist);
            		}
            		else {
...
HXLINE( 326)		{
HXLINE( 326)			 ::Dynamic key = this->_cache->keys();
...
HXLINE( 328)				 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key1).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE( 344)		{
HXLINE( 344)			 ::Dynamic key = this->_cache->keys();
HXDLIN( 344)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 344)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 346)				 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key1).StaticCast<  ::flixel::graphics::FlxGraphic >();
HXLINE( 347)				if (hx::IsNotNull( obj )) {
...
HXDLIN( 360)		 ::Dynamic key = this->_cache->keys();
HXDLIN( 360)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXDLIN( 360)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 362)			 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key1).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXDLIN( 373)		return ( (int)(::openfl::_legacy::gl::GL_obj::lime_gl_get_parameter((int)3379)) );
            	}
...
HXLINE( 381)			 ::openfl::_legacy::display::BitmapData bd =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,(int)10,(int)10,true,(int)-1,null());
HXLINE( 382)			 ::flixel::graphics::FlxGraphic graphic = ::flixel::FlxG_obj::bitmap->add(bd,true,HX_("whitePixels",b6,92,ba,9e));
