...
HX_LOCAL_STACK_FRAME(_hx_pos_cd150b1d3fa70035_22_draw,"flixel.system.FlxBGSprite","draw",0x1cf08403,"flixel.system.FlxBGSprite.draw","flixel/system/FlxBGSprite.hx",22,0xa9844f6f)
namespace flixel{
...
HXDLIN(  22)		::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN(  22)		while((_g < _g1->length)){
HXDLIN(  22)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
