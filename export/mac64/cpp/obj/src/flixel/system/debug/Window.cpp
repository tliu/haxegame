...
HXDLIN( 405)		if (hx::IsNotNull( this->_bounds )) {
HXLINE( 407)			Float Value = this->get_x();
HXDLIN( 407)			 ::Dynamic Min = this->_bounds->get_left();
HXDLIN( 407)			Float Max = this->_bounds->get_right();
HXDLIN( 407)			 ::Dynamic Max1 = (Max - this->_width);
HXDLIN( 407)			Float lowerBound;
...
HXLINE( 407)				_hx_tmp1 = hx::IsGreater( lowerBound,Max1 );
            			}
            			else {
HXLINE( 407)				_hx_tmp1 = false;
            			}
HXDLIN( 407)			if (_hx_tmp1) {
HXLINE( 407)				_hx_tmp = Max1;
            			}
            			else {
HXLINE( 407)				_hx_tmp = lowerBound;
            			}
HXDLIN( 407)			this->set_x(_hx_tmp);
HXLINE( 408)			Float Value1 = this->get_y();
HXDLIN( 408)			 ::Dynamic Min1 = this->_bounds->get_top();
HXDLIN( 408)			Float Max2 = this->_bounds->get_bottom();
HXDLIN( 408)			 ::Dynamic Max3 = (Max2 - this->_height);
HXDLIN( 408)			Float lowerBound2;
...
HXLINE( 408)				_hx_tmp3 = hx::IsGreater( lowerBound2,Max3 );
            			}
            			else {
HXLINE( 408)				_hx_tmp3 = false;
            			}
HXDLIN( 408)			if (_hx_tmp3) {
HXLINE( 408)				_hx_tmp2 = Max3;
            			}
            			else {
...
HXLINE( 417)		Float Value = this->_width;
HXDLIN( 417)		 ::Dynamic Min = this->minSize->x;
HXDLIN( 417)		 ::Dynamic Max = this->maxSize->x;
HXDLIN( 417)		Float lowerBound;
...
HXLINE( 418)		Float Value1 = this->_height;
HXDLIN( 418)		 ::Dynamic Min1 = this->minSize->y;
HXDLIN( 418)		 ::Dynamic Max1 = this->maxSize->y;
HXDLIN( 418)		Float lowerBound2;
...
HXLINE( 425)		 ::openfl::_legacy::text::TextField _hx_tmp6 = this->_title;
HXDLIN( 425)		_hx_tmp6->set_width((this->_width - (int)4));
HXLINE( 426)		if (this->_resizable) {
HXLINE( 428)			 ::openfl::_legacy::display::Bitmap _hx_tmp7 = this->_handle;
HXDLIN( 428)			int _hx_tmp8 = this->_width;
HXDLIN( 428)			_hx_tmp7->set_x((_hx_tmp8 - this->_handle->get_width()));
HXLINE( 429)			 ::openfl::_legacy::display::Bitmap _hx_tmp9 = this->_handle;
HXDLIN( 429)			int _hx_tmp10 = this->_height;
HXDLIN( 429)			_hx_tmp9->set_y((_hx_tmp10 - this->_handle->get_height()));
            		}
HXLINE( 431)		if (hx::IsNotNull( this->_closeButton )) {
HXLINE( 433)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp11 = this->_closeButton;
HXDLIN( 433)			int _hx_tmp12 = this->_width;
HXDLIN( 433)			_hx_tmp11->set_x(((_hx_tmp12 - this->_closeButton->get_width()) - (int)3));
