...
HXDLIN(  92)		sClickEvents = ::Array_obj< ::String >::fromData( _hx_array_data_10cf350e_82,3);
            	}
{
            	HX_STACKFRAME(&_hx_pos_d4acca48e18394dd_93_boot)
HXDLIN(  93)		sDownEvents = ::Array_obj< ::String >::fromData( _hx_array_data_10cf350e_84,3);
            	}
{
            	HX_STACKFRAME(&_hx_pos_d4acca48e18394dd_94_boot)
HXDLIN(  94)		sUpEvents = ::Array_obj< ::String >::fromData( _hx_array_data_10cf350e_86,3);
            	}
{
